...
_SERVICE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='proto', full_name='vaksana.Service.proto', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='infra', full_name='vaksana.Service.infra', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='container', full_name='vaksana.Service.container', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='function', full_name='vaksana.Service.function', index=3,
...
_INTENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='service', full_name='vaksana.Intent.service', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVICE.fields_by_name['proto'].message_type = _PROTO
_SERVICE.fields_by_name['infra'].message_type = _INFRA
...
_INTENT.fields_by_name['service'].message_type = _SERVICE
