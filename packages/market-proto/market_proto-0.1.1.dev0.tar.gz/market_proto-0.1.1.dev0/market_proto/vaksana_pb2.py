...
_MARKET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RegisterIntent',
    full_name='vaksana.Market.RegisterIntent',
    index=6,
    containing_service=None,
    input_type=_CINTENT,
