...
class PrimitiveWrapper(_object):
    ...
    def inner(self):
        return _libpasta.PrimitiveWrapper_inner(self)
    __swig_destroy__ = _libpasta.delete_PrimitiveWrapper
...
class Config(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        with_primitive = staticmethod(_libpasta.Config_with_primitive)
    else:
        with_primitive = _libpasta.Config_with_primitive
...
def Config_with_primitive(p):
    return _libpasta.Config_with_primitive(p)
Config_with_primitive = _libpasta.Config_with_primitive
