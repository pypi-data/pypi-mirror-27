...
class TeamsApi(object):
    ...
    def get_team_prompt_campaigns(self, client_group_id, **kwargs):
        ...
        :param str order_by: How to sort the column
        :param str asc: Ascending or not
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_team_prompt_campaigns_with_http_info(self, client_group_id, **kwargs):
        ...
        all_params = ['client_group_id', 'search_term', 'order_by', 'asc']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
