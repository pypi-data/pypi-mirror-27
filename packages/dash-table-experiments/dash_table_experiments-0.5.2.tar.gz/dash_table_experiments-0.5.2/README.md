...
### Usage In Multi-Page Apps ###

**Note** - Due to a design flaw in Dash, you **always need to define the `dash_table_experiments.DataTable` in
your initial app** (it can be hidden) like this:
...
See https://community.plot.ly/t/display-tables-in-dash/4707/40?u=chriddyp for more details.
