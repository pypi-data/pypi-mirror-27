from RedisQ.useage.jobs import *
from RedisQ.useage.WSIWorker import WSIWorker, PlayLoadConfig
from redis import Redis
from RedisQ.Qlist import LQ, LW, LD
import requests
...
def main(host, port):
    ...
    worker = WSIWorker(connection=conn, config=config,
