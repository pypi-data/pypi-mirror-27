...
def get_size_netmask(decimal_mask):
    try: 
        check_mask(decimal_mask)
	decimal_mask=convert_address_to_binary(decimal_mask)
    except:
	pass
...
def get_nb_host(subnet_mask):
    try:
        ...
        no_of_ones=get_size_netmask(decimal_mask)
...
print(get_size_netmask("255.255.255.0"))
