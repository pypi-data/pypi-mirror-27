...
from anji_orm import register, StringField, DatetimeField, ListField, DictField, FloatField, EnumField
...
class BaseTask(SecureModel, TimeSeriesMixin):  # pylint: disable=too-many-instance-attributes
    ...
    def additional_statistic_filter(cls, current_query_dict: Dict) -> Dict:
        current_query_dict['status'] = TaskStatus.done
