...
export const pluginRoutes = [
    ...
    {
        path: 'peek_core_email',
        loadChildren: "peek_core_email/core-email.module#CoreEmailAdminModule"
    },
    {
    ...
    {
        path: 'peek_plugin_generic_diagram_menu',
        loadChildren: "peek_plugin_generic_diagram_menu/genericDiagramMenu.module#GenericDiagramMenuModule"
    },
    {
    ...
    {
        path: 'peek_plugin_pof_email_incidents',
        loadChildren: "peek_plugin_pof_email_incidents/pofEmailIncidents.module#PofEmailIncidentsModule"
    },
    {
    ...
    {
        path: 'peek_plugin_pof_user_loader',
        loadChildren: "peek_plugin_pof_user_loader/pofUserLoader.module#PofUserLoaderModule"
    },
    {
        path: 'peek_plugin_user',
        loadChildren: "peek_plugin_user/user.module#UserModule"
    },
    {
        path: 'peek_plugin_zepben_diagram_menu',
        loadChildren: "peek_plugin_zepben_diagram_menu/zepbenDiagramMenu.module#ZepbenDiagramMenuModule"
    }
];
