-- schapp schema version 4, ABuS v8, v9
...
-- files that are known not to exist any more (because missing from latest run)
create table deletion(
   path text not null,
   timestamp float not null); -- time first detected deleted
