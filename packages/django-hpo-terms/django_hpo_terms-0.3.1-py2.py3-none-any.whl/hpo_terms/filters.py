...
class TermFilter(django_filters.rest_framework.FilterSet):
    ...
    version_label = django_filters.CharFilter(
        name='version__label',
        label='Version Label',
    ...
    diseases__description = django_filters.CharFilter(
        name='diseases__description',
        method='filter_diseases_description',
    ...
    def filter_diseases_description(self, queryset, name, value):
        return queryset.filter(Q(diseases__description__icontains=value))
...
class DiseaseGeneFilter(django_filters.rest_framework.FilterSet):
    ...
    hpo_terms = django_filters.CharFilter(
    ...
    def filter_hpo_terms(self, queryset, name, value):
        return queryset.filter(
            Q(diseases__hpo_terms__label__icontains=value) |
            Q(diseases__hpo_terms__description__icontains=value) |
            Q(diseases__hpo_terms__synonyms__description__icontains=value)
        )
