...
from PyQt5.QtWidgets import QAction, QDialog, QGridLayout, QGroupBox, QHBoxLayout, QInputDialog, QLabel, QMenu, QMessageBox, QSizePolicy, QTextEdit, QToolButton, QVBoxLayout, QWidget, QPushButton
...
class FrmArguments( QDialog ):
    ...
    def __init_controls( self ):
        ...
        if self.main_help_layout is not None:
            self.__delete_children( self.main_help_layout )
