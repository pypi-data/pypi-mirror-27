...
class ProjectMixin():
    ...
    def edit_project(self):
        ...
        try:
            ...
            self.helptxt = {
                "dc_path": _("Full path to docker-compose.yml"),
                "name": _("Project Name"),
                "env_vars": _(
    ...
    def get_data_from_compose(self):
        ...
        for key in self.compose['services']:
            ...
            container_type = console.choose(
                ...
                default=old_data['type'] if old_data else self._get_application_default(key)
            )
            ...
            if container_base == "build":
                ...
                repo = console.ask(
                    _("Repository URL"),
                    required=True,
                    default=old_data['repo'] if old_data else None
                )
