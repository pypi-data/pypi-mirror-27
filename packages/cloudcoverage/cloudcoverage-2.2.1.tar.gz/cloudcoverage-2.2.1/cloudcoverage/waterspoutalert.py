...
def send_message(imagepath, recipients, frompassword):
    """This function creates and sends the email"""
    #imagepath is for the attachment, Waterspout picture
    #recipients is a text file with recipient email addresses
    lines = send_to(recipients)
    toaddr = lines
