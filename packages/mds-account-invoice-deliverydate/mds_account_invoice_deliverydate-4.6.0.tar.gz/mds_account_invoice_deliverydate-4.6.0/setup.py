""" Tryton module to add delivery-date to invoices
""" 
...
MODULE = 'account_invoice_deliverydate'
PREFIX = 'mds'
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='Tryton module to add delivery-date to invoices',
    ...
    keywords='tryton invoice delivery date',
