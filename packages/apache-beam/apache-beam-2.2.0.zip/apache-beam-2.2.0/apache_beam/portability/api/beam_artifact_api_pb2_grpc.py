...
class ArtifactStagingServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.PutArtifact = channel.stream_unary(
        '/org.apache.beam.runner_api.v1.ArtifactStagingService/PutArtifact',
    ...
    self.CommitManifest = channel.unary_unary(
        '/org.apache.beam.runner_api.v1.ArtifactStagingService/CommitManifest',
...
def add_ArtifactStagingServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'org.apache.beam.runner_api.v1.ArtifactStagingService', rpc_method_handlers)
...
class ArtifactRetrievalServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetManifest = channel.unary_unary(
        '/org.apache.beam.runner_api.v1.ArtifactRetrievalService/GetManifest',
    ...
    self.GetArtifact = channel.unary_stream(
        '/org.apache.beam.runner_api.v1.ArtifactRetrievalService/GetArtifact',
...
def add_ArtifactRetrievalServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'org.apache.beam.runner_api.v1.ArtifactRetrievalService', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
