...
class SQL:
	...
	def _join	(self, jtype, obj, alias, *Qs, **filters):
		...
		if not isinstance (obj, str):
			...
			obj = "({})".format (obj)
		self._joins.append (
			"{} JOIN {} AS {} ON {}".format (jtype, obj, alias, _filters)
		)
		return self
	
	def join	(self, obj, alias, *Qs, **filters):
		return self._join ("INNER", obj, alias, *Qs, **filters)
	
	def left_join	(self, obj, alias, *Qs, **filters):
		return self._join ("LEFT OUTER", obj, alias, *Qs, **filters)
	
	def right_join	(self, obj, alias, *Qs, **filters):
		return self._join ("RIGHT OUTER", obj, alias, *Qs, **filters)
	
	def full_join	(self, obj, alias, *Qs, **filters):
		return self._join ("FULL OUTER", obj, alias, *Qs, **filters)
