...
.. code:: python
  ...
  q = sp.ops.select ("tbl_file", "type", "count(*) cnt")
...
.. code:: python  
  ...
  q = sp.ops.insert ("tbl_file", score = None)  
...
You can use 'from_ ()' for update query,
