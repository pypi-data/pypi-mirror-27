...
def IN (*lst):
	return "IN ({})".format (",".join ([d.toval (each) for each in lst]))

def B (a, b):
	return "BETWEEN {} AND {}".format (d.toval (a), d.toval (b))		
...
class Q:
	...
	def __len__ (self):
		return (self._str or self.v is not None) and 1 or 0
