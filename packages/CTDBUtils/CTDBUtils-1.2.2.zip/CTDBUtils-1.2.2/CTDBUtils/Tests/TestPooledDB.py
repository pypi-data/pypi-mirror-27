...
sys.path.insert(1, '../..')
from CTDBUtils.Tests import TestSteadyDB as dbapi
from CTDBUtils.PooledDB import (PooledDB, SharedDBConnection,
...
class TestPooledDB(unittest.TestCase):
    ...
    def test03_CreateConnection(self):
        for threadsafety in (1, 2):
            ...
            from CTDBUtils.SteadyDB import SteadyDBConnection
