...
sys.path.insert(1, '../..')
from CTDBUtils.Tests import TestSteadyPg as pg
from CTDBUtils.PersistentPg import PersistentPg
...
class TestPersistentPg(unittest.TestCase):
    ...
    def test0_CheckVersion(self):
        ...
        from CTDBUtils.PersistentPg import __version__ as PersistentPgVersion
