...
sys.path.insert(1, '../..')
from CTDBUtils.SteadyDB import connect as SteadyDBconnect
from CTDBUtils.SteadyDB import SteadyDBConnection, SteadyDBCursor
...
class TestSteadyDB(unittest.TestCase):
    ...
    def test00_CheckVersion(self):
        ...
        from CTDBUtils.SteadyDB import __version__ as SteadyDBVersion
