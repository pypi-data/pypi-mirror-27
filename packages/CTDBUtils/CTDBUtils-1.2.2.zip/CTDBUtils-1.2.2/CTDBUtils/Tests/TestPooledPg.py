...
from CTDBUtils.Tests import TestSteadyPg
from CTDBUtils.PooledPg import PooledPg, InvalidConnection
...
class TestPooledPg(unittest.TestCase):
    ...
    def test0_CheckVersion(self):
        ...
        from CTDBUtils.PooledPg import __version__ as PooledPgVersion
    ...
    def test1_CreateConnection(self):
        ...
        from CTDBUtils.SteadyPg import SteadyPgConnection
    ...
    def test4_MaxConnections(self):
        from CTDBUtils.PooledPg import TooManyConnections
        pool = PooledPg(1, 2, 3)
        self.assertEqual(pool._cache.qsize(), 1)
        cache = []
        for i in range(3):
