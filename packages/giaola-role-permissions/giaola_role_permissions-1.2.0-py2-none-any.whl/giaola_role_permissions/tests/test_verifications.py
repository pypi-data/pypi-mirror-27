...
from giaola_role_permissions.verifications import has_role, has_roles, has_permission, has_object_permission
from giaola_role_permissions.permissions import register_object_checker
