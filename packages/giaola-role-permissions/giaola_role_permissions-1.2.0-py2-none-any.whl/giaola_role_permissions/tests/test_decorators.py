...
from giaola_role_permissions.roles import AbstractUserRole
from giaola_role_permissions.decorators import has_role_decorator, has_roles_decorator, has_permission_decorator
...
@override_settings(
    ...
    ROOT_URLCONF='giaola_role_permissions.tests.mock_urls')
