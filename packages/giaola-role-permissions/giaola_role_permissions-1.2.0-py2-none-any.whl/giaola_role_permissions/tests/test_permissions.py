...
from giaola_role_permissions.permissions import PermissionsManager, register_object_checker
from giaola_role_permissions.exceptions import CheckerNotRegistered
