...
class MySQLStorage(SessionStorage):
    ...
    MySQLStorage 会把你的 Session 数据储存在 MySQL 中 ::
        ...
        import weapprobot
        from weapprobot.session.mysqlstorage import MySQLStorage
    ...
    def get(self, id):
        ...
        cur.execute("SELECT value FROM WeAppRobot WHERE id=%s LIMIT 1;", (id,))
    ...
    def set(self, id, value):
        ...
        self.conn.cursor().execute("INSERT INTO WeAppRobot (id, value) VALUES (%s,%s) \
    ...
    def delete(self, id):
        ...
        :param id: 要删除的数据的 id
        """
        self.conn.cursor().execute("DELETE FROM WeAppRobot WHERE id=%s", (id,))
        self.conn.commit()
