...
def make_view(robot):
    ...
    Usage ::
        ...
        from weapprobot import WeAppRobot

        robot = WeAppRobot(token='token')
        ...
        from weapprobot.contrib.flask import make_view

        app = Flask(__name__)
        app.add_url_rule(rule='/robot/', # WeAppRobot 的绑定地址
                        endpoint='weapprobot', # Flask 的 endpoint
