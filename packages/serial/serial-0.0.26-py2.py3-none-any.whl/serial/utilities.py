...
class Unidentified(object):
    """
    Instances of this class represent an unspecified parameter, to be used as a default value, allowing `None`
    to have semantic meaning.
    """
    ...
    def __repr__(self):
        return qualified_name(type(self))
