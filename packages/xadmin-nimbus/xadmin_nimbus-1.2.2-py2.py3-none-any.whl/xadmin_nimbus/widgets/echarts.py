...
class EChartsView(EChartsMixin, ListAdminView):
    ...
    def get_echarts_xfield(self, name=None, chart=None, xfield=None, obj=None, format="%Y-%m-%d %H:%M:%S"):
        value = super(EChartsView, self).get_echarts_xfield(name=name, chart=chart, xfield=xfield, obj=obj, format=format)
        return value or self.make_chart_xfield(name=name, chart=chart, xfield=xfield, obj=obj, format=format)

    def get_echarts_yfield(self, name=None, chart=None, yfield=None, obj=None):
        value = super(EChartsView, self).get_echarts_yfield(name=name, chart=chart, yfield=yfield, obj=obj)
        return value or self.make_chart_yfield(name=name, chart=chart, yfield=yfield, obj=obj)
    ...
    def get_echarts_datas(self, name=None, chart=None, echarts_type=None, xfield=None, yfields=None):
        return self.make_chart_result_list(name=name, chart=chart)
