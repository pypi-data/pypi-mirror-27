...
Version Info:
  $Id: setup.py,v 1.22.2 2010/08/18 06:46:32 noboru Exp noboru $
  $Revision: 1.22.2 $
  $Author: noboru $
  $Log: setup.py,v $

  Revision 1.22.2  2010/08/18 06:46:32  noboru
  support python3
...
setup(name="PythonCA",
      ...
      py_modules=["ca", "caError", "cadefs","_ca_kek","_ca_fnal","CaChannel","printfn","WFmemleakCheck"],
