...
####+BEGIN: bx:icm:python:cmnd:classHead :modPrefix "new" :cmndName "sendFromPartialFileWithPars" :comment "" :parsMand "" :parsOpt "outMailAcct inFile submissionMethod" :argsMin "0" :argsMax "0" :asFunc "msg" :interactiveP ""
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || ICM-Cmnd       :: /sendFromPartialFileWithPars/ parsMand= parsOpt=outMailAcct inFile submissionMethod argsMin=0 argsMax=0 asFunc=msg interactive=  [[elisp:(org-cycle)][| ]]
"""
class sendFromPartialFileWithPars(icm.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ 'outMailAcct', 'inFile', 'submissionMethod', ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
