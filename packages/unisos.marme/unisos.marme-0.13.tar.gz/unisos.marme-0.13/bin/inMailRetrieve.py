...
class examples(icm.Cmnd):
    ...
    def cmnd(self,
        ...
        if not icm.cmndCallParamsValidate(callParamsDict, interactive, outcome=cmndOutcome):
            return cmndOutcome
####+END:
        """cmnd of SomeCmnd function longer docString."""
        myName=self.myName()
        #G = icm.IcmGlobalContext()        
...
"""
class offlineimapRunOld(icm.Cmnd):
    """."""
...
####+BEGIN: bx:dblock:python:icm:cmnd:parsValidate :par "controlProfile inMailAcct"

####+END:

####+BEGIN: bx:icm:python:cmnd:classHead :modPrefix "new" :cmndName "offlineimapRun" :comment "" :parsMand "" :parsOpt "controlProfile inMailAcct" :argsMin "0" :argsMax "0" :asFunc "" :interactiveP ""
"""
...
####+BEGIN: bx:icm:python:cmnd:classHead :modPrefix "new" :cmndName "offlineimaprcUpdate" :comment "" :parsMand "" :parsOpt "controlProfile inMailAcct" :argsMin "0" :argsMax "0" :asFunc "" :interactiveP ""
"""
...
####+BEGIN: bx:icm:python:cmnd:classHead :modPrefix "new" :cmndName "offlineimaprcStdout" :comment "" :parsMand "" :parsOpt "inMailAcct mboxesList ssl" :argsMin "0" :argsMax "0" :asFunc "" :interactiveP ""
"""
