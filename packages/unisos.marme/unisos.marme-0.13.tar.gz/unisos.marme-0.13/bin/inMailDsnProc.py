...
class maildirApplyToMsg(icm.Cmnd):
    ...
    def argsSpec(self):
        """ """
        # cmndArgs = icm.IIF_args()

        # cmndArgObj = cmndArgs.obtainObj(
        ...
        # cmndArgs.append(cmndArgObj)

####+BEGIN: bx:dblock:python:icm:cmnd:parsValidate :par "controlProfile inMailAcct inMbox"
