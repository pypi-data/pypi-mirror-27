...
class SecurityTemplate:
    ...
    def aws_auth(self, **kwargs):
        ...
        self.aws_client = self.aws_session.client('cloudformation')
    ...
    def describe_change_set(self, **kwargs):
        ...
        if self.aws_client:
            response = self.aws_client.describe_change_set(**kwargs)
            return response
    ...
    def delete_stack(self, stack_name):
        if self.aws_client:
            self.aws_client.delete_stack(StackName=stack_name)
            print "[INFO] Deleting Stack " + stack_name
