...
webui.SideBarView = function(mainView) {
    ...
    self.element = $(   '<div id="sidebar">' +
                            '<a href="'+ webui.urlindex +'" id="urlindex"><i id="sidebar-logo" class="fa fa-git-square fa-3x" aria-hidden="true"></i></a>' +
                            '<div id="sidebar-content">' +
                                '<section id="sidebar-workspace">' +
                                    '<h4><i class="fa fa-desktop" aria-hidden="true"></i> Workspace</h4>' +
                                '</section>' +
                                '<section id="sidebar-remote">' +
                                    '<h4><i class="fa fa-globe" aria-hidden="true"></i> Remote access</h4>' +
                                '</section>' +
                                '<section id="sidebar-local-branches">' +
                                    '<h4><i class="fa fa-code-fork" aria-hidden="true"></i> Local</h4>' +
                                '</section>' +
                                '<section id="sidebar-remote-branches">' +
                                    '<h4><i class="fa fa-code-fork" aria-hidden="true"></i> Remote</h4>' +
                                '</section>' +
    ...
    if (webui.viewonly) {
        ...
        $("#sidebar-remote", self.element).remove();
    }
...
webui.CommitView = function(historyView) {
    ...
    var buttonBox = new webui.TabBox([['<i class="fa fa-clock-o" aria-hidden="true"></i> Commit', self.showDiff], ['<i class="fa fa-folder-open-o" aria-hidden="true"></i> Tree', self.showTree]]);
...
webui.RemoteView = function(mainView) {
    ...
    self.element = $(   '<div class="jumbotron">' +
                            ...
                            '</div>' +
                        '</div>')[0];
    $(".git-clone", self.element).text("git clone " + webui.urlrepos );
    $(".git-pull", self.element).text("git pull " + webui.urlrepos );
};
