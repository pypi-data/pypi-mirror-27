...
export declare var GlyphView: {
    new (options?: {}): {
        ...
        draw_legend_for_index(ctx: any, x0: any, x1: any, y0: any, y1: any, index: any): null;
...
export declare class Glyph extends Model {
    static coords(coords: any): any[];
}
