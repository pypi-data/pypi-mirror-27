...
export declare var CategoricalAxisView: {
    new (options?: {}): {
        _render(ctx: any, extents: any, tick_coords: any): void;
        _draw_group_separators(ctx: any, extents: any, tick_coords: any): void;
        _draw_major_labels(ctx: any, extents: any, tick_coords: any): void;
        _tick_label_extents(): number[];
        _get_factor_info(): any[][];
        render(): any;
        connect_signals(): any;
        _get_size(): any;
        get_size(): number;
