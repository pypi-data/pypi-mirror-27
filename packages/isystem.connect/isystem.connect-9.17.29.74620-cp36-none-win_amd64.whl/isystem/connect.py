...
class CProfilerArea2(_object):
    ...
    EFilter = _connect.CProfilerArea2_EFilter
    EStateFilter = _connect.CProfilerArea2_EStateFilter
...
class CProfilerExportConfig(_object):
    ...
    def setAreaExportSections(self, isExportFunctions: 'bool', isExportLines: 'bool', isExportData: 'bool', isExportAUX: 'bool') -> "isys::CProfilerExportConfig &":
        return _connect.CProfilerExportConfig_setAreaExportSections(self, isExportFunctions, isExportLines, isExportData, isExportAUX)
...
_connect.acquFilter_swigconstant(_connect)
acquFilter = _connect.acquFilter
