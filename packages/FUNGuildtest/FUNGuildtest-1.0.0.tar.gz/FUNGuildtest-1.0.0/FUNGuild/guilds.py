...
def main():
    import argparse
    import funguilds as gd
    
    parser = argparse.ArgumentParser()
    parser.add_argument('-otu', help='Filename of the OTU table, it can be in the format of either BIOM-JSON or tab-delimited.')
    parser.add_argument('-format', choices=['biom', 'biom-json', 'tab', 'tab-delimited'], default='biom', \
                         help='Specify the file format. FUNGuild supports BIOM-JSON or tab-delimited forms.')
    ...
    taxa = gd.taxa_parser(otu_file, otu_format = otu_format, taxa_column = taxa_column)
