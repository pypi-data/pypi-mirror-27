...
class FsClient(RussellHttpClient):
    ...
    def socket_upload(self, file_type, filename, access_token, file_id, user_name, data_name, is_compress=True):
        ...
        self.FILE_NAME = '{}.tar.gz'.format(file_id) if is_compress \
            else '{}.tar'.format(file_id)
