...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    GetNeedsState                           = 0xc4 # Anki.Cozmo.ExternalInterface.GetNeedsState
    ForceSetNeedsLevels                     = 0xc5 # Anki.Cozmo.ExternalInterface.ForceSetNeedsLevels
    ForceSetDamagedParts                    = 0xc6 # Anki.Cozmo.ExternalInterface.ForceSetDamagedParts
    RegisterOnboardingComplete              = 0xc7 # Anki.Cozmo.ExternalInterface.RegisterOnboardingComplete
    SetNeedsPauseState                      = 0xc8 # Anki.Cozmo.ExternalInterface.SetNeedsPauseState
    GetNeedsPauseState                      = 0xc9 # Anki.Cozmo.ExternalInterface.GetNeedsPauseState
    SetNeedsPauseStates                     = 0xca # Anki.Cozmo.ExternalInterface.SetNeedsPauseStates
    GetNeedsPauseStates                     = 0xcb # Anki.Cozmo.ExternalInterface.GetNeedsPauseStates
    SetNeedsActionWhitelist                 = 0xcc # Anki.Cozmo.ExternalInterface.SetNeedsActionWhitelist
    RegisterNeedsActionCompleted            = 0xcd # Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
    GetWantsNeedsOnboarding                 = 0xce # Anki.Cozmo.ExternalInterface.GetWantsNeedsOnboarding
    WipeRobotNeedsData                      = 0xcf # Anki.Cozmo.ExternalInterface.WipeRobotNeedsData
    WipeDeviceNeedsData                     = 0xd0 # Anki.Cozmo.ExternalInterface.WipeDeviceNeedsData
    GetStarStatus                           = 0xd1 # Anki.Cozmo.ExternalInterface.GetStarStatus
    GetSongsList                            = 0xd2 # Anki.Cozmo.ExternalInterface.GetSongsList
    NotificationsManagerReady               = 0xd3 # Anki.Cozmo.ExternalInterface.NotificationsManagerReady
    RequestNotificationTextKeys             = 0xd4 # Anki.Cozmo.ExternalInterface.RequestNotificationTextKeys
    RequestSetUnlock                        = 0xd5 # Anki.Cozmo.ExternalInterface.RequestSetUnlock
    InventoryRequestAdd                     = 0xd6 # Anki.Cozmo.ExternalInterface.InventoryRequestAdd
    InventoryRequestSet                     = 0xd7 # Anki.Cozmo.ExternalInterface.InventoryRequestSet
    InventoryRequestGet                     = 0xd8 # Anki.Cozmo.ExternalInterface.InventoryRequestGet
    RequestDeviceData                       = 0xd9 # Anki.Cozmo.ExternalInterface.RequestDeviceData
    SetDebugConsoleVarMessage               = 0xda # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xdb # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xdc # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xdd # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xde # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    SetEnableSpeedChooser                   = 0xdf # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    LogRawCliffData                         = 0xe0 # Anki.Cozmo.ExternalInterface.LogRawCliffData
    BlockPoolEnabledMessage                 = 0xe1 # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xe2 # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xe3 # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xe4 # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xe5 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xe6 # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xe7 # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xe8 # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xe9 # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xea # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xeb # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xec # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xed # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xee # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    SetShouldAutoConnectToCubesAtStart      = 0xef # Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
    SetShouldAutoDisconnectFromCubesAtEnd   = 0xf0 # Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
    TransferFile                            = 0xf1 # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xf2 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xf3 # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xf4 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xf5 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xf6 # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xf7 # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xf8 # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  _tags_by_name = dict(
    ...
    MoodMessage=195,
    GetNeedsState=196,
    ForceSetNeedsLevels=197,
    ForceSetDamagedParts=198,
    RegisterOnboardingComplete=199,
    SetNeedsPauseState=200,
    GetNeedsPauseState=201,
    SetNeedsPauseStates=202,
    GetNeedsPauseStates=203,
    SetNeedsActionWhitelist=204,
    RegisterNeedsActionCompleted=205,
    GetWantsNeedsOnboarding=206,
    WipeRobotNeedsData=207,
    WipeDeviceNeedsData=208,
    GetStarStatus=209,
    GetSongsList=210,
    NotificationsManagerReady=211,
    RequestNotificationTextKeys=212,
    RequestSetUnlock=213,
    InventoryRequestAdd=214,
    InventoryRequestSet=215,
    InventoryRequestGet=216,
    RequestDeviceData=217,
    SetDebugConsoleVarMessage=218,
    RunDebugConsoleFuncMessage=219,
    GetDebugConsoleVarMessage=220,
    GetAllDebugConsoleVarMessage=221,
    GetJsonDasLogsMessage=222,
    SetEnableSpeedChooser=223,
    LogRawCliffData=224,
    BlockPoolEnabledMessage=225,
    BlockSelectedMessage=226,
    GetBlockPoolMessage=227,
    SendAvailableObjects=228,
    BlockPoolResetMessage=229,
    SaveCalibrationImage=230,
    ClearCalibrationImages=231,
    ComputeCameraCalibration=232,
    ContinueFreeplayFromIdle=233,
    EnableDroneMode=234,
    EnterSdkMode=235,
    ExitSdkMode=236,
    SetStopRobotOnSdkDisconnect=237,
    StopRobotForSdk=238,
    SetShouldAutoConnectToCubesAtStart=239,
    SetShouldAutoDisconnectFromCubesAtEnd=240,
    TransferFile=241,
    NVStorageEraseEntry=242,
    NVStorageWipeAll=243,
    NVStorageWriteEntry=244,
    NVStorageClearPartialPendingWriteEntry=245,
    NVStorageReadEntry=246,
    SetCameraSettings=247,
    RequestRobotSettings=248,
  )
  ...
  _tags_by_value[196] = 'GetNeedsState'
  _tags_by_value[197] = 'ForceSetNeedsLevels'
  _tags_by_value[198] = 'ForceSetDamagedParts'
  _tags_by_value[199] = 'RegisterOnboardingComplete'
  _tags_by_value[200] = 'SetNeedsPauseState'
  _tags_by_value[201] = 'GetNeedsPauseState'
  _tags_by_value[202] = 'SetNeedsPauseStates'
  _tags_by_value[203] = 'GetNeedsPauseStates'
  _tags_by_value[204] = 'SetNeedsActionWhitelist'
  _tags_by_value[205] = 'RegisterNeedsActionCompleted'
  _tags_by_value[206] = 'GetWantsNeedsOnboarding'
  _tags_by_value[207] = 'WipeRobotNeedsData'
  _tags_by_value[208] = 'WipeDeviceNeedsData'
  _tags_by_value[209] = 'GetStarStatus'
  _tags_by_value[210] = 'GetSongsList'
  _tags_by_value[211] = 'NotificationsManagerReady'
  _tags_by_value[212] = 'RequestNotificationTextKeys'
  _tags_by_value[213] = 'RequestSetUnlock'
  _tags_by_value[214] = 'InventoryRequestAdd'
  _tags_by_value[215] = 'InventoryRequestSet'
  _tags_by_value[216] = 'InventoryRequestGet'
  _tags_by_value[217] = 'RequestDeviceData'
  _tags_by_value[218] = 'SetDebugConsoleVarMessage'
  _tags_by_value[219] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[220] = 'GetDebugConsoleVarMessage'
  _tags_by_value[221] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[222] = 'GetJsonDasLogsMessage'
  _tags_by_value[223] = 'SetEnableSpeedChooser'
  _tags_by_value[224] = 'LogRawCliffData'
  _tags_by_value[225] = 'BlockPoolEnabledMessage'
  _tags_by_value[226] = 'BlockSelectedMessage'
  _tags_by_value[227] = 'GetBlockPoolMessage'
  _tags_by_value[228] = 'SendAvailableObjects'
  _tags_by_value[229] = 'BlockPoolResetMessage'
  _tags_by_value[230] = 'SaveCalibrationImage'
  _tags_by_value[231] = 'ClearCalibrationImages'
  _tags_by_value[232] = 'ComputeCameraCalibration'
  _tags_by_value[233] = 'ContinueFreeplayFromIdle'
  _tags_by_value[234] = 'EnableDroneMode'
  _tags_by_value[235] = 'EnterSdkMode'
  _tags_by_value[236] = 'ExitSdkMode'
  _tags_by_value[237] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[238] = 'StopRobotForSdk'
  _tags_by_value[239] = 'SetShouldAutoConnectToCubesAtStart'
  _tags_by_value[240] = 'SetShouldAutoDisconnectFromCubesAtEnd'
  _tags_by_value[241] = 'TransferFile'
  _tags_by_value[242] = 'NVStorageEraseEntry'
  _tags_by_value[243] = 'NVStorageWipeAll'
  _tags_by_value[244] = 'NVStorageWriteEntry'
  _tags_by_value[245] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[246] = 'NVStorageReadEntry'
  _tags_by_value[247] = 'SetCameraSettings'
  _tags_by_value[248] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[196] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsState.unpack_from)
  _tag_unpack_methods[197] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceSetNeedsLevels.unpack_from)
  _tag_unpack_methods[198] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceSetDamagedParts.unpack_from)
  _tag_unpack_methods[199] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RegisterOnboardingComplete.unpack_from)
  _tag_unpack_methods[200] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseState.unpack_from)
  _tag_unpack_methods[201] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseState.unpack_from)
  _tag_unpack_methods[202] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsPauseStates.unpack_from)
  _tag_unpack_methods[203] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetNeedsPauseStates.unpack_from)
  _tag_unpack_methods[204] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetNeedsActionWhitelist.unpack_from)
  _tag_unpack_methods[205] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted.unpack_from)
  _tag_unpack_methods[206] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetWantsNeedsOnboarding.unpack_from)
  _tag_unpack_methods[207] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeRobotNeedsData.unpack_from)
  _tag_unpack_methods[208] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeDeviceNeedsData.unpack_from)
  _tag_unpack_methods[209] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetStarStatus.unpack_from)
  _tag_unpack_methods[210] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetSongsList.unpack_from)
  _tag_unpack_methods[211] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NotificationsManagerReady.unpack_from)
  _tag_unpack_methods[212] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestNotificationTextKeys.unpack_from)
  _tag_unpack_methods[213] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlock.unpack_from)
  _tag_unpack_methods[214] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryRequestAdd.unpack_from)
  _tag_unpack_methods[215] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryRequestSet.unpack_from)
  _tag_unpack_methods[216] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryRequestGet.unpack_from)
  _tag_unpack_methods[217] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDeviceData.unpack_from)
  _tag_unpack_methods[218] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[219] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[220] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[221] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[222] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[223] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[224] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LogRawCliffData.unpack_from)
  _tag_unpack_methods[225] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[226] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[227] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[228] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[229] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[230] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[231] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[232] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[233] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[234] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[235] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[236] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[237] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[238] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[239] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart.unpack_from)
  _tag_unpack_methods[240] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd.unpack_from)
  _tag_unpack_methods[241] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[242] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[243] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[244] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[245] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[246] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[247] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[248] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[196] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsState
  _type_by_tag_value[197] = lambda : Anki.Cozmo.ExternalInterface.ForceSetNeedsLevels
  _type_by_tag_value[198] = lambda : Anki.Cozmo.ExternalInterface.ForceSetDamagedParts
  _type_by_tag_value[199] = lambda : Anki.Cozmo.ExternalInterface.RegisterOnboardingComplete
  _type_by_tag_value[200] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseState
  _type_by_tag_value[201] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseState
  _type_by_tag_value[202] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsPauseStates
  _type_by_tag_value[203] = lambda : Anki.Cozmo.ExternalInterface.GetNeedsPauseStates
  _type_by_tag_value[204] = lambda : Anki.Cozmo.ExternalInterface.SetNeedsActionWhitelist
  _type_by_tag_value[205] = lambda : Anki.Cozmo.ExternalInterface.RegisterNeedsActionCompleted
  _type_by_tag_value[206] = lambda : Anki.Cozmo.ExternalInterface.GetWantsNeedsOnboarding
  _type_by_tag_value[207] = lambda : Anki.Cozmo.ExternalInterface.WipeRobotNeedsData
  _type_by_tag_value[208] = lambda : Anki.Cozmo.ExternalInterface.WipeDeviceNeedsData
  _type_by_tag_value[209] = lambda : Anki.Cozmo.ExternalInterface.GetStarStatus
  _type_by_tag_value[210] = lambda : Anki.Cozmo.ExternalInterface.GetSongsList
  _type_by_tag_value[211] = lambda : Anki.Cozmo.ExternalInterface.NotificationsManagerReady
  _type_by_tag_value[212] = lambda : Anki.Cozmo.ExternalInterface.RequestNotificationTextKeys
  _type_by_tag_value[213] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlock
  _type_by_tag_value[214] = lambda : Anki.Cozmo.ExternalInterface.InventoryRequestAdd
  _type_by_tag_value[215] = lambda : Anki.Cozmo.ExternalInterface.InventoryRequestSet
  _type_by_tag_value[216] = lambda : Anki.Cozmo.ExternalInterface.InventoryRequestGet
  _type_by_tag_value[217] = lambda : Anki.Cozmo.ExternalInterface.RequestDeviceData
  _type_by_tag_value[218] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[219] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[220] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[221] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[222] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[223] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[224] = lambda : Anki.Cozmo.ExternalInterface.LogRawCliffData
  _type_by_tag_value[225] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[226] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[227] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[228] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[229] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[230] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[231] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[232] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[233] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[234] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[235] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[236] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[237] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[238] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[239] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoConnectToCubesAtStart
  _type_by_tag_value[240] = lambda : Anki.Cozmo.ExternalInterface.SetShouldAutoDisconnectFromCubesAtEnd
  _type_by_tag_value[241] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[242] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[243] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[244] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[245] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[246] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[247] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[248] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
