...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    RobotProcessedImage             = 0x42 # Anki.Cozmo.ExternalInterface.RobotProcessedImage
    RobotObservedObject             = 0x43 # Anki.Cozmo.ExternalInterface.RobotObservedObject
    RobotObservedPossibleObject     = 0x44 # Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
    RobotObservedFace               = 0x45 # Anki.Cozmo.ExternalInterface.RobotObservedFace
    RobotChangedObservedFaceID      = 0x46 # Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
    RobotObservedPet                = 0x47 # Anki.Cozmo.ExternalInterface.RobotObservedPet
    RobotObservedMotion             = 0x48 # Anki.Cozmo.ExternalInterface.RobotObservedMotion
    RobotObservedLaserPoint         = 0x49 # Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint
    RobotDeletedFace                = 0x4a # Anki.Cozmo.ExternalInterface.RobotDeletedFace
    RobotDeletedLocatedObject       = 0x4b # Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
    RobotDeletedAllCustomObjects    = 0x4c # Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
    RobotDeletedFixedCustomObjects  = 0x4d # Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
    RobotDeletedCustomMarkerObjects = 0x4e # Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
    CreatedFixedCustomObject        = 0x4f # Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
    DefinedCustomObject             = 0x50 # Anki.Cozmo.ExternalInterface.DefinedCustomObject
    RobotMarkedObjectPoseUnknown    = 0x51 # Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
    LocatedObjectStates             = 0x52 # Anki.Cozmo.ExternalInterface.LocatedObjectStates
    ConnectedObjectStates           = 0x53 # Anki.Cozmo.ExternalInterface.ConnectedObjectStates
    RobotReadToolCode               = 0x54 # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted         = 0x55 # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace         = 0x56 # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces     = 0x57 # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest    = 0x58 # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction            = 0x59 # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                   = 0x5a # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                     = 0x5b # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable              = 0x5c # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable         = 0x5d # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted                = 0x5e # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                  = 0x5f # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                       = 0x60 # Anki.Cozmo.ExternalInterface.MoodState
    NeedsState                      = 0x61 # Anki.Cozmo.ExternalInterface.NeedsState
    NeedsPauseState                 = 0x62 # Anki.Cozmo.ExternalInterface.NeedsPauseState
    NeedsPauseStates                = 0x63 # Anki.Cozmo.ExternalInterface.NeedsPauseStates
    FreeplaySparksAwarded           = 0x64 # Anki.Cozmo.ExternalInterface.FreeplaySparksAwarded
    StarLevelCompleted              = 0x65 # Anki.Cozmo.ExternalInterface.StarLevelCompleted
    StarUnlocked                    = 0x66 # Anki.Cozmo.ExternalInterface.StarUnlocked
    StarStatus                      = 0x67 # Anki.Cozmo.ExternalInterface.StarStatus
    WantsNeedsOnboarding            = 0x68 # Anki.Cozmo.ExternalInterface.WantsNeedsOnboarding
    SongsList                       = 0x69 # Anki.Cozmo.ExternalInterface.SongsList
    RequestSetUnlockResult          = 0x6a # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                    = 0x6b # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults                = 0x6c # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InventoryStatus                 = 0x6d # Anki.Cozmo.ExternalInterface.InventoryStatus
    RequestDefaultSparks            = 0x6e # Anki.Cozmo.ExternalInterface.RequestDefaultSparks
    InitDebugConsoleVarMessage      = 0x6f # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage               = 0x70 # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage        = 0x71 # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage   = 0x72 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage    = 0x73 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine       = 0x74 # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                  = 0x75 # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage               = 0x76 # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus            = 0x77 # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState               = 0x78 # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage          = 0x79 # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition       = 0x7a # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage            = 0x7b # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult               = 0x7c # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress          = 0x7d # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete          = 0x7e # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart                = 0x7f # Anki.Cozmo.ExternalInterface.RequestGameStart
    HardSparkStartedByEngine        = 0x80 # Anki.Cozmo.ExternalInterface.HardSparkStartedByEngine
    HardSparkEndedByEngine          = 0x81 # Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
    SdkConnectionStatus             = 0x82 # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                       = 0x83 # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition              = 0x84 # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionTriggerTransition       = 0x85 # Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
    RespondAllBehaviorsList         = 0x86 # Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList
    RespondReactionTriggerMap       = 0x87 # Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap
    BehaviorObjectiveAchieved       = 0x88 # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    PyramidPreReqState              = 0x89 # Anki.Cozmo.ExternalInterface.PyramidPreReqState
    GuardDogStart                   = 0x8a # Anki.Cozmo.ExternalInterface.GuardDogStart
    GuardDogEnd                     = 0x8b # Anki.Cozmo.ExternalInterface.GuardDogEnd
    OnboardingState                 = 0x8c # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin           = 0x8d # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage                = 0x8e # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd             = 0x8f # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                     = 0x90 # Anki.Cozmo.ExternalInterface.SupportInfo
    FeedingSFXStageUpdate           = 0x91 # Anki.Cozmo.ExternalInterface.FeedingSFXStageUpdate
    ResponseLocale                  = 0x92 # Anki.Cozmo.ExternalInterface.ResponseLocale
    ClearNotificationCache          = 0x93 # Anki.Cozmo.ExternalInterface.ClearNotificationCache
    CacheNotificationToSchedule     = 0x94 # Anki.Cozmo.ExternalInterface.CacheNotificationToSchedule
    NotificationTextKeys            = 0x95 # Anki.Cozmo.ExternalInterface.NotificationTextKeys
    EndOfMessage                    = 0x96 # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  _tags_by_name = dict(
    ...
    RobotProcessedImage=66,
    RobotObservedObject=67,
    RobotObservedPossibleObject=68,
    RobotObservedFace=69,
    RobotChangedObservedFaceID=70,
    RobotObservedPet=71,
    RobotObservedMotion=72,
    RobotObservedLaserPoint=73,
    RobotDeletedFace=74,
    RobotDeletedLocatedObject=75,
    RobotDeletedAllCustomObjects=76,
    RobotDeletedFixedCustomObjects=77,
    RobotDeletedCustomMarkerObjects=78,
    CreatedFixedCustomObject=79,
    DefinedCustomObject=80,
    RobotMarkedObjectPoseUnknown=81,
    LocatedObjectStates=82,
    ConnectedObjectStates=83,
    RobotReadToolCode=84,
    FaceEnrollmentCompleted=85,
    RobotErasedEnrolledFace=86,
    RobotErasedAllEnrolledFaces=87,
    RobotCompletedFactoryDotTest=88,
    RobotCompletedAction=89,
    BlockPickedUp=90,
    BlockPlaced=91,
    AnimationAvailable=92,
    AnimationGroupAvailable=93,
    AnimationAborted=94,
    AnimationEvent=95,
    MoodState=96,
    NeedsState=97,
    NeedsPauseState=98,
    NeedsPauseStates=99,
    FreeplaySparksAwarded=100,
    StarLevelCompleted=101,
    StarUnlocked=102,
    StarStatus=103,
    WantsNeedsOnboarding=104,
    SongsList=105,
    RequestSetUnlockResult=106,
    UnlockStatus=107,
    UnlockedDefaults=108,
    InventoryStatus=109,
    RequestDefaultSparks=110,
    InitDebugConsoleVarMessage=111,
    JsonDasLogMessage=112,
    JsonDasLogAllSentMessage=113,
    VerifyDebugConsoleFuncMessage=114,
    VerifyDebugConsoleVarMessage=115,
    DebugAppendConsoleLogLine=116,
    LatencyMessage=117,
    DeviceDataMessage=118,
    BlockTapFilterStatus=119,
    UpdateEngineState=120,
    EngineErrorCodeMessage=121,
    CubeLightsStateTransition=122,
    BlockPoolDataMessage=123,
    NVStorageOpResult=124,
    FirmwareUpdateProgress=125,
    FirmwareUpdateComplete=126,
    RequestGameStart=127,
    HardSparkStartedByEngine=128,
    HardSparkEndedByEngine=129,
    SdkConnectionStatus=130,
    SdkStatus=131,
    BehaviorTransition=132,
    ReactionTriggerTransition=133,
    RespondAllBehaviorsList=134,
    RespondReactionTriggerMap=135,
    BehaviorObjectiveAchieved=136,
    PyramidPreReqState=137,
    GuardDogStart=138,
    GuardDogEnd=139,
    OnboardingState=140,
    MemoryMapMessageBegin=141,
    MemoryMapMessage=142,
    MemoryMapMessageEnd=143,
    SupportInfo=144,
    FeedingSFXStageUpdate=145,
    ResponseLocale=146,
    ClearNotificationCache=147,
    CacheNotificationToSchedule=148,
    NotificationTextKeys=149,
    EndOfMessage=150,
  )
  ...
  _tags_by_value[66] = 'RobotProcessedImage'
  _tags_by_value[67] = 'RobotObservedObject'
  _tags_by_value[68] = 'RobotObservedPossibleObject'
  _tags_by_value[69] = 'RobotObservedFace'
  _tags_by_value[70] = 'RobotChangedObservedFaceID'
  _tags_by_value[71] = 'RobotObservedPet'
  _tags_by_value[72] = 'RobotObservedMotion'
  _tags_by_value[73] = 'RobotObservedLaserPoint'
  ...
  _tags_by_value[77] = 'RobotDeletedFixedCustomObjects'
  _tags_by_value[78] = 'RobotDeletedCustomMarkerObjects'
  _tags_by_value[79] = 'CreatedFixedCustomObject'
  _tags_by_value[80] = 'DefinedCustomObject'
  _tags_by_value[81] = 'RobotMarkedObjectPoseUnknown'
  _tags_by_value[82] = 'LocatedObjectStates'
  _tags_by_value[83] = 'ConnectedObjectStates'
  _tags_by_value[84] = 'RobotReadToolCode'
  _tags_by_value[85] = 'FaceEnrollmentCompleted'
  _tags_by_value[86] = 'RobotErasedEnrolledFace'
  _tags_by_value[87] = 'RobotErasedAllEnrolledFaces'
  _tags_by_value[88] = 'RobotCompletedFactoryDotTest'
  _tags_by_value[89] = 'RobotCompletedAction'
  _tags_by_value[90] = 'BlockPickedUp'
  _tags_by_value[91] = 'BlockPlaced'
  _tags_by_value[92] = 'AnimationAvailable'
  _tags_by_value[93] = 'AnimationGroupAvailable'
  _tags_by_value[94] = 'AnimationAborted'
  _tags_by_value[95] = 'AnimationEvent'
  _tags_by_value[96] = 'MoodState'
  _tags_by_value[97] = 'NeedsState'
  _tags_by_value[98] = 'NeedsPauseState'
  _tags_by_value[99] = 'NeedsPauseStates'
  _tags_by_value[100] = 'FreeplaySparksAwarded'
  _tags_by_value[101] = 'StarLevelCompleted'
  _tags_by_value[102] = 'StarUnlocked'
  _tags_by_value[103] = 'StarStatus'
  _tags_by_value[104] = 'WantsNeedsOnboarding'
  _tags_by_value[105] = 'SongsList'
  _tags_by_value[106] = 'RequestSetUnlockResult'
  _tags_by_value[107] = 'UnlockStatus'
  _tags_by_value[108] = 'UnlockedDefaults'
  _tags_by_value[109] = 'InventoryStatus'
  _tags_by_value[110] = 'RequestDefaultSparks'
  _tags_by_value[111] = 'InitDebugConsoleVarMessage'
  _tags_by_value[112] = 'JsonDasLogMessage'
  _tags_by_value[113] = 'JsonDasLogAllSentMessage'
  _tags_by_value[114] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[115] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[116] = 'DebugAppendConsoleLogLine'
  _tags_by_value[117] = 'LatencyMessage'
  _tags_by_value[118] = 'DeviceDataMessage'
  _tags_by_value[119] = 'BlockTapFilterStatus'
  _tags_by_value[120] = 'UpdateEngineState'
  _tags_by_value[121] = 'EngineErrorCodeMessage'
  _tags_by_value[122] = 'CubeLightsStateTransition'
  _tags_by_value[123] = 'BlockPoolDataMessage'
  _tags_by_value[124] = 'NVStorageOpResult'
  _tags_by_value[125] = 'FirmwareUpdateProgress'
  _tags_by_value[126] = 'FirmwareUpdateComplete'
  _tags_by_value[127] = 'RequestGameStart'
  _tags_by_value[128] = 'HardSparkStartedByEngine'
  _tags_by_value[129] = 'HardSparkEndedByEngine'
  _tags_by_value[130] = 'SdkConnectionStatus'
  _tags_by_value[131] = 'SdkStatus'
  _tags_by_value[132] = 'BehaviorTransition'
  _tags_by_value[133] = 'ReactionTriggerTransition'
  _tags_by_value[134] = 'RespondAllBehaviorsList'
  _tags_by_value[135] = 'RespondReactionTriggerMap'
  _tags_by_value[136] = 'BehaviorObjectiveAchieved'
  _tags_by_value[137] = 'PyramidPreReqState'
  _tags_by_value[138] = 'GuardDogStart'
  _tags_by_value[139] = 'GuardDogEnd'
  _tags_by_value[140] = 'OnboardingState'
  _tags_by_value[141] = 'MemoryMapMessageBegin'
  _tags_by_value[142] = 'MemoryMapMessage'
  _tags_by_value[143] = 'MemoryMapMessageEnd'
  _tags_by_value[144] = 'SupportInfo'
  _tags_by_value[145] = 'FeedingSFXStageUpdate'
  _tags_by_value[146] = 'ResponseLocale'
  _tags_by_value[147] = 'ClearNotificationCache'
  _tags_by_value[148] = 'CacheNotificationToSchedule'
  _tags_by_value[149] = 'NotificationTextKeys'
  _tags_by_value[150] = 'EndOfMessage'
  ...
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotProcessedImage.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedObject.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedFace.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPet.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedMotion.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFace.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefinedCustomObject.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LocatedObjectStates.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectedObjectStates.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsState.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseState.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NeedsPauseStates.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FreeplaySparksAwarded.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarLevelCompleted.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarUnlocked.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StarStatus.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WantsNeedsOnboarding.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SongsList.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InventoryStatus.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDefaultSparks.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkStartedByEngine.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionTriggerTransition.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PyramidPreReqState.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GuardDogStart.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GuardDogEnd.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[145] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FeedingSFXStageUpdate.unpack_from)
  _tag_unpack_methods[146] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ResponseLocale.unpack_from)
  _tag_unpack_methods[147] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearNotificationCache.unpack_from)
  _tag_unpack_methods[148] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CacheNotificationToSchedule.unpack_from)
  _tag_unpack_methods[149] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NotificationTextKeys.unpack_from)
  _tag_unpack_methods[150] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[66] = lambda : Anki.Cozmo.ExternalInterface.RobotProcessedImage
  _type_by_tag_value[67] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedObject
  _type_by_tag_value[68] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedFace
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPet
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedMotion
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedLaserPoint
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFace
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFixedCustomObjects
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedCustomMarkerObjects
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.DefinedCustomObject
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.LocatedObjectStates
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.ConnectedObjectStates
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.NeedsState
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseState
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.NeedsPauseStates
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.FreeplaySparksAwarded
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.StarLevelCompleted
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.StarUnlocked
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.StarStatus
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.WantsNeedsOnboarding
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.SongsList
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.InventoryStatus
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.RequestDefaultSparks
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.HardSparkStartedByEngine
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.RespondAllBehaviorsList
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.RespondReactionTriggerMap
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.PyramidPreReqState
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.GuardDogStart
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.GuardDogEnd
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[145] = lambda : Anki.Cozmo.ExternalInterface.FeedingSFXStageUpdate
  _type_by_tag_value[146] = lambda : Anki.Cozmo.ExternalInterface.ResponseLocale
  _type_by_tag_value[147] = lambda : Anki.Cozmo.ExternalInterface.ClearNotificationCache
  _type_by_tag_value[148] = lambda : Anki.Cozmo.ExternalInterface.CacheNotificationToSchedule
  _type_by_tag_value[149] = lambda : Anki.Cozmo.ExternalInterface.NotificationTextKeys
  _type_by_tag_value[150] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage
