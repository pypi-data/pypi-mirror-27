...
VER_PATCH = 3  # bump PATCH version when only bug-fixes are introduced (no new features)
VER_BUILD = 26  # BUILD version is automatically incremented by the build server 
