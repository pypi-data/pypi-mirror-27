...
VER_PATCH = 4  # bump PATCH version when only bug-fixes are introduced (no new features)
VER_BUILD = 28  # BUILD version is automatically incremented by the build server 
