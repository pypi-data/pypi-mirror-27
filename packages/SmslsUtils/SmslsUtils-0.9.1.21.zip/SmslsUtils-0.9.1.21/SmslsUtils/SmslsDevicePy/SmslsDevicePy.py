...
class ServoApi(_object):
    ...
    def GetPositionKeypointFromIndex(self, motorId, keypointIndex, keypointId):
        return _SmslsDevicePy.ServoApi_GetPositionKeypointFromIndex(self, motorId, keypointIndex, keypointId)
    ...
    def GetCurrentPositionAsKeypoint(self, motorId, keypointId):
        return _SmslsDevicePy.ServoApi_GetCurrentPositionAsKeypoint(self, motorId, keypointId)
