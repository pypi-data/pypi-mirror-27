...
##                           ['Label', 'WALLISTARGSTDEV_ID', 6, 0, False, None, None, 0],  
##                           ['DoubleSpinBox', '', 7, 0, True, window.TargStdevInit, window.TargStdevUpdate, 0],    
##                           ['Label', 'WALLISSETGAIN_ID', 8, 0, False, None, None, 0],  
##                           ['DoubleSpinBox', '', 9, 0, True, window.SetGainInit, window.SetGainUpdate, 0],    
##                           ['Label', 'WALLISLIMIT_ID', 10, 0, False, None, None, 0],  
##                           ['DoubleSpinBox', '', 11, 0, True, window.LimitInit, window.LimitUpdate, 0],    
##                           ['Label', 'WALLISEDGEFACTOR_ID', 12, 0, False, None, None, 0],  
##                           ['DoubleSpinBox', '', 13, 0, True, window.EdgeFactorInit, window.EdgeFactorUpdate, 0],
                           ['Label', 'FILTERNXSIZE_ID', 0, 0, False, None, None, 0],  
                           ['SpinBox', '', 1, 0, True, window.NxSizeInit, window.NxSizeUpdate, 0], 
