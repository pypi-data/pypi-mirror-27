...
You can install, upgrade, uninstall wumappy using ``pip`` with these commands:
...
WuMapPy is only a GUI and all geophysical processing are acually done by the GeophPy module. To use WuMapPy-v0.30 you need the package GeophPy-v0.30 to be installed.
...
GeophPy dependencies (verified on Windows):
