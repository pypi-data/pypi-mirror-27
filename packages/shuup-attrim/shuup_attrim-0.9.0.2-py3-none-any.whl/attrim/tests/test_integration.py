...
from attrim.tests.testproject.settings import IS_SHUUP_TEST_LOCAL
from attrim.tests.testproject.settings import ATTRIM_IS_SKIP_INTEGRATION
...
class IntegrationTest(IntegrationTestCase):
    ...
    @skipIf(ATTRIM_IS_SKIP_INTEGRATION == True, 'The env var is setted to skip the tests.')
