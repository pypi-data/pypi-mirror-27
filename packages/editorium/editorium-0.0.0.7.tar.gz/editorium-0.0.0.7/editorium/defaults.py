...
def default_editorium():
    ...
    if __default_editorium is None:
        from editorium.editorium_qt import EditorBase, Editorium, Editor_Bool, Editor_Enum, Editor_Flags, Editor_Float, Editor_Int, Editor_Filename, Editor_String, Editor_List, Editor_Nullable, Editor_Fallback, Editor_ReadOnly, Editor_Annotation
        ...
        __default_editorium.editors.append( Editor_List )
...
def register( editor_or_function ) -> None:
    ...
    :param editor_or_function: Either:
                                    ...
                                    * A collection of editors (must be `list` or `tuple`)
