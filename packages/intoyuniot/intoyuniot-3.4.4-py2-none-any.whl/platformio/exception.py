...
class InvalidLibConfURL(PlatformioException):
    ...
    MESSAGE = "Invalid argument: '{0}'. Url start with 'http(s)' OR File ends with '.tar.gz/.zip' are supported"


class InvalidLibFile(PlatformioException):

    MESSAGE = "file '{0}' not exists or exceeds 1MB"
