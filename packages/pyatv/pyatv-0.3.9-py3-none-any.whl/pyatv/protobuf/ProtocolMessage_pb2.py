...
# source: pyatv/protobuf/ProtocolMessage.proto
...
_PROTOCOLMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='deviceInfoMessage', full_name='ProtocolMessage.deviceInfoMessage', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cryptoPairingMessage', full_name='ProtocolMessage.cryptoPairingMessage', index=4,
...
_PROTOCOLMESSAGE.fields_by_name['deviceInfoMessage'].message_type = _DEVICEINFOMESSAGE
_PROTOCOLMESSAGE.fields_by_name['cryptoPairingMessage'].message_type = _CRYPTOPAIRINGMESSAGE
...
ProtocolMessage = _reflection.GeneratedProtocolMessageType('ProtocolMessage', (_message.Message,), dict(
  ...
  __module__ = 'pyatv.protobuf.ProtocolMessage_pb2'
