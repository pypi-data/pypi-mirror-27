    ...
    def update(self):
        ...
        for orb_path_for7 in self.icc7_paths:
            ...
            db_data = (meteor_id, \
                                ...
                                unicode(str(icc7_data['radiant_cov_ra_dec']), "utf-8"), \
                                \
                                ...
                                unicode(str(icc7_data['radiant_cov_ecsc_long_lat']), "utf-8"), \
                                \
                                ...
                                unicode(str(icc7_data['radiant_cov_eclip_long_lat']), "utf-8"), \
                                \
                                ...
                                \
                                unicode(str(icc7_data['conics_earth_cov']), "utf-8"), \
                                \
                                ...
                                \
                                unicode(str(icc7_data['conics_helio_cov']), "utf-8"), \
                                \
        ...
        for orb_path_for9 in self.icc9_paths:
            ...
            db_data = (meteor_id, \
                                ...
                                unicode(str(icc9_data['radiant_cov_ra_dec']), "utf-8"), \
                                \
                                ...
                                unicode(str(icc9_data['radiant_cov_ecsc_long_lat']), "utf-8"), \
                                \
                                ...
                                unicode(str(icc9_data['radiant_cov_eclip_long_lat']), "utf-8"), \
                                \
                                ...
                                \
                                unicode(str(icc9_data['conics_earth_cov']), "utf-8"), \
                                \
                                ...
                                \
                                unicode(str(icc9_data['conics_helio_cov']), "utf-8"), \
                                \
