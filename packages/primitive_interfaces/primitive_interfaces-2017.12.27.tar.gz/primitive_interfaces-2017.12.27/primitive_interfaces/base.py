...
class GradientCompositionalityMixin(typing.Generic[Inputs, Outputs, Params, Hyperparams]):
    ...
    * Hamiltonian Monte Carlo
    ...
    @abc.abstractmethod
    def backward(self, *, gradient_outputs: Gradients[Outputs], fine_tune: bool = False, learning_rate: float = 0.00001,
                 weight_decay: float = 0.00001) -> typing.Tuple[Gradients[Inputs], Scores[Params]]:
        """
