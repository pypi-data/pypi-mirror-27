...
class Chrome(BaseChrome):
    ...
    def __init__(self, browser_config):
        if Chrome.factory is None:
            ...
            Chrome.factory = ChromeDevToolFactory(browser_config=browser_config)
...
class ChromeTab(BaseChrome):
    ...
    def __init__(self, browser_config):
        if ChromeTab.factory is None:
            ...
            ChromeTab.factory = ChromeTabDevToolFactory(browser_config=browser_config)
        else:
