...
options:
  ...
  load_balancer_status:
    description:
        - (deprecated) The field has been deprecated from ansible-alicloud v1.1.2.
  address_type:
    description:
        - (deprecated) The field has been deprecated from ansible-alicloud v1.1.2 and 'is_internet' will replace.
  is_internet:
    description:
