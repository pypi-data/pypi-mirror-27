...
class CreateAttribute(object):
    ...
    def __init__(self, value=None, enumeration=None, type=None):
        """
    ...
    def enumeration(self):
        """
        Gets the enumeration of this CreateAttribute.
        Values that the attribute can take. Use only if the attribute's category is category

        :return: The enumeration of this CreateAttribute.
    ...
    def enumeration(self, enumeration):
        ...
        :param enumeration: The enumeration of this CreateAttribute.
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["text", "date", "float", "id", "category"]
