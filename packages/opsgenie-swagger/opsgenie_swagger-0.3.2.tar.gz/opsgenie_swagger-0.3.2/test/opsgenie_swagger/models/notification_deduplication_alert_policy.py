...
class NotificationDeduplicationAlertPolicy(object):
    ...
    def __init__(self, deduplication_action_type=None, count=None, duration=None):  # noqa: E501
        """NotificationDeduplicationAlertPolicy - a model defined in Swagger"""  # noqa: E501
    ...
    def deduplication_action_type(self):
        """Gets the deduplication_action_type of this NotificationDeduplicationAlertPolicy.  # noqa: E501

        Deduplication type  # noqa: E501

        :return: The deduplication_action_type of this NotificationDeduplicationAlertPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def deduplication_action_type(self, deduplication_action_type):
        """Sets the deduplication_action_type of this NotificationDeduplicationAlertPolicy.

        Deduplication type  # noqa: E501

        :param deduplication_action_type: The deduplication_action_type of this NotificationDeduplicationAlertPolicy.  # noqa: E501
        :type: str
        """
    ...
    @property
    def count(self):
        """Gets the count of this NotificationDeduplicationAlertPolicy.  # noqa: E501

        Number of alerts before deduplication  # noqa: E501

        :return: The count of this NotificationDeduplicationAlertPolicy.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this NotificationDeduplicationAlertPolicy.

        Number of alerts before deduplication  # noqa: E501

        :param count: The count of this NotificationDeduplicationAlertPolicy.  # noqa: E501
        :type: int
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this NotificationDeduplicationAlertPolicy.  # noqa: E501

        Interval to keep count of alerts for frequency based deduplication  # noqa: E501

        :return: The duration of this NotificationDeduplicationAlertPolicy.  # noqa: E501
        :rtype: Duration
        """
    ...
    def duration(self, duration):
        """Sets the duration of this NotificationDeduplicationAlertPolicy.

        Interval to keep count of alerts for frequency based deduplication  # noqa: E501

        :param duration: The duration of this NotificationDeduplicationAlertPolicy.  # noqa: E501
        :type: Duration
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotificationDeduplicationAlertPolicy):
            return False
