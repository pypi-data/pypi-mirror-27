from bitfeeds.driver.wss import WebSocketApiClient
...
from bitfeeds.sql_client_template import SqlClientTemplate
...
class BitstampBroker(WebSocketApiClient):
    """
    Exchange socket
    """
    def __init__(self):
        ...
        Constructor
        """
        WebSocketApiClient.__init__(self, 'BitstampBroker')
