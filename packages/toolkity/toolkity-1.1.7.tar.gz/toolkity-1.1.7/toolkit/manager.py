...
class Blocker(object):
    ...
    def myfunc(self):
        with SleepManager(sleep_time, self, interval=1, notify=lambda x: x.alive) as sm:
            ...
            ....
    """
    def __init__(self, block_time, instance, interval=1, notify=lambda x: x.alive, immediately=False):
        """
    ...
    def __enter__(self):
        while not self.immediately and time.time() - self.enter_time < self.block_time and self.notify(self.instance):
