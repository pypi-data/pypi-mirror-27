...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_vnl_c_vectorPython')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_vnl_c_vectorPython')
...
class vnl_c_vectorCF(object):
    ...
    def allocate_Tptr(n: 'unsigned long const') -> "stdcomplexF **":
    ...
    def allocate_T(n: 'unsigned long const') -> "stdcomplexF *":
...
def vnl_c_vectorCF_allocate_Tptr(n: 'unsigned long const') -> "stdcomplexF **":
    """vnl_c_vectorCF_allocate_Tptr(unsigned long const n) -> stdcomplexF **"""
    return _vnl_c_vectorPython.vnl_c_vectorCF_allocate_Tptr(n)

def vnl_c_vectorCF_allocate_T(n: 'unsigned long const') -> "stdcomplexF *":
...
def vnl_c_vectorD_allocate_Tptr(n: 'unsigned long const') -> "double **":
    """vnl_c_vectorD_allocate_Tptr(unsigned long const n) -> double **"""
    return _vnl_c_vectorPython.vnl_c_vectorD_allocate_Tptr(n)

def vnl_c_vectorD_allocate_T(n: 'unsigned long const') -> "double *":
...
def vnl_c_vectorF_allocate_Tptr(n: 'unsigned long const') -> "float **":
    """vnl_c_vectorF_allocate_Tptr(unsigned long const n) -> float **"""
    return _vnl_c_vectorPython.vnl_c_vectorF_allocate_Tptr(n)

def vnl_c_vectorF_allocate_T(n: 'unsigned long const') -> "float *":
...
def vnl_c_vectorLD_allocate_Tptr(n: 'unsigned long const') -> "long double **":
    """vnl_c_vectorLD_allocate_Tptr(unsigned long const n) -> long double **"""
    return _vnl_c_vectorPython.vnl_c_vectorLD_allocate_Tptr(n)

def vnl_c_vectorLD_allocate_T(n: 'unsigned long const') -> "long double *":
...
def vnl_c_vectorSC_allocate_Tptr(n: 'unsigned long const') -> "signed char **":
    """vnl_c_vectorSC_allocate_Tptr(unsigned long const n) -> signed char **"""
    return _vnl_c_vectorPython.vnl_c_vectorSC_allocate_Tptr(n)

def vnl_c_vectorSC_allocate_T(n: 'unsigned long const') -> "signed char *":
...
def vnl_c_vectorSI_allocate_Tptr(n: 'unsigned long const') -> "int **":
    """vnl_c_vectorSI_allocate_Tptr(unsigned long const n) -> int **"""
    return _vnl_c_vectorPython.vnl_c_vectorSI_allocate_Tptr(n)

def vnl_c_vectorSI_allocate_T(n: 'unsigned long const') -> "int *":
...
def vnl_c_vectorSL_allocate_Tptr(n: 'unsigned long const') -> "long **":
    """vnl_c_vectorSL_allocate_Tptr(unsigned long const n) -> long **"""
    return _vnl_c_vectorPython.vnl_c_vectorSL_allocate_Tptr(n)

def vnl_c_vectorSL_allocate_T(n: 'unsigned long const') -> "long *":
...
def vnl_c_vectorUC_allocate_Tptr(n: 'unsigned long const') -> "unsigned char **":
    """vnl_c_vectorUC_allocate_Tptr(unsigned long const n) -> unsigned char **"""
    return _vnl_c_vectorPython.vnl_c_vectorUC_allocate_Tptr(n)

def vnl_c_vectorUC_allocate_T(n: 'unsigned long const') -> "unsigned char *":
...
def vnl_c_vectorUI_allocate_Tptr(n: 'unsigned long const') -> "unsigned int **":
    """vnl_c_vectorUI_allocate_Tptr(unsigned long const n) -> unsigned int **"""
    return _vnl_c_vectorPython.vnl_c_vectorUI_allocate_Tptr(n)

def vnl_c_vectorUI_allocate_T(n: 'unsigned long const') -> "unsigned int *":
...
def vnl_c_vectorUL_allocate_Tptr(n: 'unsigned long const') -> "unsigned long **":
    """vnl_c_vectorUL_allocate_Tptr(unsigned long const n) -> unsigned long **"""
    return _vnl_c_vectorPython.vnl_c_vectorUL_allocate_Tptr(n)

def vnl_c_vectorUL_allocate_T(n: 'unsigned long const') -> "unsigned long *":
