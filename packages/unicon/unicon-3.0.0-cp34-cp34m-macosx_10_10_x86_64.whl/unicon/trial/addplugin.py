...
if __name__ == "__main__":
    ...
    if create_plugin == 'yes':
        ...
        plugin_templates = yaml.load(jinja_template.render(variables))
        ...
        unittest_templates = yaml.load(jinja_template.render(variables))
        ...
        mock_data_templates = yaml.load(jinja_template.render(variables))

        for module in mock_data_templates:
            mock_data_directory = os.path.join(unicon_dir, 'tests/unittest/mock_data/{}'.format(plugin_name))
