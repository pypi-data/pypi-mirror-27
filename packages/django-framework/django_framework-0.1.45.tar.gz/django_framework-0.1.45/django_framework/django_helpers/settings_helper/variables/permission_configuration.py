...
class PermissionConfiguration(BaseVariable):
    ...
    def _check_check_model_data_with_permissions(self, value):
        ...
        if value == False:
            print('WARNING, this is less secure as it will allow users to set rows or reassign rows to someone else!')
        return True
    ...
    def _check_get_model_with_permissions(self, value):
        ...
        if value == False:
            print('WARNING, this is very insecure as the user will be able to see things that they shouldnt!!')
