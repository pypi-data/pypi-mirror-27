...
class ExperimentCollection:
    ...
    def all(self):
        ...
        if all_experiments is not None:
            ...
            for iter1 in resr:
                ...
                ver_url = iter1.entity['experiment_version']
    ...
    def get(self, experiment_id):
        ...
        if experiment_output is not None:
            ver_url = experiment_output.entity['experiment_version']
    ...
    def save(self, artifact):
        ...
        try:
            ...
            if experiment_id is None:
                ...
                location_match = re.search('.*/v3/ml_assets/experiments/([A-Za-z0-9\\-]+)', location)
                ...
                version_location = experiment_artifact.meta.prop(MetaNames.EXPERIMENT_VERSION_URL)
                #version_id = experiment_artifact.meta.prop(MetaNames.VERSION).encode('ascii')
    ...
    def _extract_experiments_from_output(self, service_output):
        ...
        latest_version = service_output[0].entity['experiment_version']
