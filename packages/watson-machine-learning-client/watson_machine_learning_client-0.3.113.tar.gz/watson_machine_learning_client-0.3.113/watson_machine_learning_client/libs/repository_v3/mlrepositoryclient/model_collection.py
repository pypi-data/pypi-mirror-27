        ...
        try:
            if artifact.uid is None:
                ...
                if pipeline_artifact.uid is None:
                    if pipeline_artifact.meta.prop(MetaNames.EXPERIMENT_VERSION_URL) is not None:
                        exp_ver_url = pipeline_artifact.meta.prop(MetaNames.EXPERIMENT_VERSION_URL).encode('utf-8')
    ...
    def _prepare_model_input(artifact):
        ...
        if artifact.meta.prop(MetaNames.FRAMEWORK_NAME).startswith("scikit") \
            ...
            model_input = MlAssetsCreateModelInput(
                ...
                name=artifact.name,
                description=meta.prop(MetaNames.DESCRIPTION),
                experiment_url=pipeline_artifact.meta.prop(MetaNames.EXPERIMENT_VERSION_URL),
                author=mauthor,
