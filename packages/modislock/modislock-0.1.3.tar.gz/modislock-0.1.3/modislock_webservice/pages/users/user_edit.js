...
function generate_pin(wizard, code){
    wizard.steps('add', {
        ...
        '                       <p class="h6">This PIN was generated by the system and is ' +
...
function generate_rfid(wizard){
    wizard.steps('add', {
        ...
        '               <p style="display: none" class="text-danger small" id="warning">RFID code should be 24 places long</p>\n' +
        '           </div>\n' +
        '           <div class="col-md-6">\n' +
        '               <div class="panel panel-success">\n' +
        '                   <div class="panel-heading">Help</div>\n' +
        '                   <div class="panel-body">\n' +
        '                       <p class="h6">A RFID code can be read in with a RFID reader or entered manually.  A NFC-enabled smartphone using a RFID scanning app can read the code for manual entry.  The RFID code should be 24 places long.</p>\n' +
        '                   </div>\n' +
        '               </div>\n' +
        '           </div>\n' +
        '       </div>\n'
...
function generate_totp(wizard, code){
    wizard.steps('add', {
        ...
        '                   <div class="panel-heading">Help</div>\n' +
        '                   <div class="panel-body">\n' +
        '                       <p class="h6">This PIN was generated by the system and is guaranteed to be unique</p>\n' +
        '                   </div>\n' +
        '               </div>\n'+
        '           </div>\n' +
        '         </div>\n'
        ...
        '                       <div class="panel-heading">Help</div>\n' +
        '                       <div class="panel-body">\n' +
        '                           <p class="h6">Use your Google Authenticator or ?? to scan in the code</p>\n' +
        '                       </div>\n' +
        '                   </div>\n' +
        '               </div>\n' +
        '           </div>\n'
...
function generate_otp(wizard){
    wizard.steps('add', {
        ...
        '                    <section>\n' +
        '                        <h4>AES Token</h4>\n' +
        '                        <p>Using the Yubico Personal Customization Tool, generate a new AES key and paste here</p>\n' +
        '                    </section>\n' +
        '                </div>\n' +
