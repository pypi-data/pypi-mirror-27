...
class PostInstallCommand(install):
    ...
    def _post_install(self):
        ...
        if os.path.islink('/etc/nginx/sites-enabled/admin_site'):
            os.remove('/etc/nginx/sites-enabled/admin_site')
        # Create new link
        os.symlink('/etc/ngnix/sites-available/admin_site', '/etc/nginx/sites-enabled/admin_site')
        ...
        args = ['systemctl', 'restart', 'supervisor']
