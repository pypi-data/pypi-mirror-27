...
class BRZipCodeField(RegexField):
    ...
    def __init__(self, max_length=None, min_length=None, *args, **kwargs):
        super(BRZipCodeField, self).__init__(r'^\d{5}-\d{3}$', max_length, min_length, *args, **kwargs)
...
class BRStateChoiceField(Field):
    ...
    def __init__(self, required=True, widget=None, label=None, initial=None, help_text=None):
        super(BRStateChoiceField, self).__init__(
            required=required, widget=widget, label=label, initial=initial, help_text=help_text
        )
...
class BRCPFField(CharField):
    ...
    def __init__(self, max_length=14, min_length=11, **kwargs):
        super(BRCPFField, self).__init__(max_length=max_length, min_length=min_length, **kwargs)
