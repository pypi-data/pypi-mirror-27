...
class Parameter_eos(object):
    ...
    def funcion_saturacion_cal(self, rk_inicial, delta_1_initial, Pvdat, Pc, Tc, Tr):
        ...
        self.presion_saturada_modelo = self.phase_equilibrium_cal(rk_inicial, delta_1_initial, Pvdat, Pc, Tc, Tr)
        self.saturation_function = abs(self.presion_saturada_modelo - Pvdat) / Pvdat
