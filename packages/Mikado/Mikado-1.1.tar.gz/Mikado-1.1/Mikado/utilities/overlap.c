 ...
 *     else:
 */
  __pyx_t_1 = PyObject_HasAttr(__pyx_v_first, __pyx_n_s_start); if (unlikely(__pyx_t_1 == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 *     else:
 */
  __pyx_t_2 = PyObject_HasAttr(__pyx_v_second, __pyx_n_s_start); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 15, __pyx_L1_error)
