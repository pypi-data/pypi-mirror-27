...
class GzipCompressor(Compressor):
    ...
    def compress(self, buffer):
        return gzip.compress(bytes(buffer, 'utf-8'))

    def decompress(self, buffer):
        return str(gzip.decompress(buffer), 'utf-8')
...
class ZipCompressor(Compressor):
    ...
    def compress(self, buffer):
        return zlib.compress(bytes(buffer, 'utf-8'), level=self.compressLevel)

    def decompress(self, buffer):
        return str(zlib.decompress(buffer), 'utf-8')
...
class Bz2Compressor(Compressor):
    ...
    def compress(self, buffer):
        return bz2.compress(bytes(buffer, 'utf-8'), compresslevel=self.compressLevel)

    def decompress(self, buffer):
        return str(bz2.decompress(buffer), 'utf-8')
