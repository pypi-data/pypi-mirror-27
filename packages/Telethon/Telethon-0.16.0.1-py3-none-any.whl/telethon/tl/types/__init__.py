...
class Config(TLObject):
    ...
    def __bytes__(self):
        ...
        return b''.join((
            b'd\t\x84\x9c',
            struct.pack('<I', (0 if self.phonecalls_enabled is None or self.phonecalls_enabled is False else 2) | (0 if self.tmp_sessions is None or self.tmp_sessions is False else 1) | (0 if self.suggested_lang_code is None or self.suggested_lang_code is False else 4) | (0 if self.lang_pack_version is None or self.lang_pack_version is False else 4)),
            TLObject.serialize_datetime(self.date),
