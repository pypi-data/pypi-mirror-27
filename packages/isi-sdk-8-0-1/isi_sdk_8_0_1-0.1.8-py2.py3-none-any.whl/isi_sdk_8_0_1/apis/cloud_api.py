...
class CloudApi(object):
    ...
    def create_cloud_account(self, cloud_account, **kwargs):
        ...
        resource_path = '/platform/4/cloud/accounts'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_cloud_proxy(self, cloud_proxy, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_cloud_proxy(cloud_proxy, callback=callback_function)
        ...
        if ('cloud_proxy' not in params) or (params['cloud_proxy'] is None):
            raise ValueError("Missing the required parameter `cloud_proxy` when calling `create_cloud_proxy`")


        resource_path = '/platform/4/cloud/proxies'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CreateCloudProxyResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def delete_cloud_account(self, cloud_account_id, **kwargs):
        ...
        resource_path = '/platform/4/cloud/accounts/{CloudAccountId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_cloud_proxy(self, cloud_proxy_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_cloud_proxy(cloud_proxy_id, callback=callback_function)
        ...
        if ('cloud_proxy_id' not in params) or (params['cloud_proxy_id'] is None):
            raise ValueError("Missing the required parameter `cloud_proxy_id` when calling `delete_cloud_proxy`")


        resource_path = '/platform/4/cloud/proxies/{CloudProxyId}'.replace('{format}', 'json')
        path_params = {}
        if 'cloud_proxy_id' in params:
            path_params['CloudProxyId'] = params['cloud_proxy_id']
    ...
    def get_cloud_proxy(self, cloud_proxy_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_cloud_proxy(cloud_proxy_id, callback=callback_function)
        ...
        # verify the required parameter 'cloud_proxy_id' is set
        if ('cloud_proxy_id' not in params) or (params['cloud_proxy_id'] is None):
            raise ValueError("Missing the required parameter `cloud_proxy_id` when calling `get_cloud_proxy`")
    ...
    def list_cloud_proxies(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_cloud_proxies(callback=callback_function)
        ...
        if 'limit' in params and params['limit'] < 1.0: 
            raise ValueError("Invalid value for parameter `limit` when calling `list_cloud_proxies`, must be a value greater than or equal to `1.0`")
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CloudProxiesExtended',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def update_cloud_proxy(self, cloud_proxy, cloud_proxy_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_cloud_proxy(cloud_proxy, cloud_proxy_id, callback=callback_function)
        ...
        all_params = ['cloud_proxy', 'cloud_proxy_id']
        all_params.append('callback')
        ...
        # verify the required parameter 'cloud_proxy' is set
        if ('cloud_proxy' not in params) or (params['cloud_proxy'] is None):
            raise ValueError("Missing the required parameter `cloud_proxy` when calling `update_cloud_proxy`")
        # verify the required parameter 'cloud_proxy_id' is set
        if ('cloud_proxy_id' not in params) or (params['cloud_proxy_id'] is None):
            raise ValueError("Missing the required parameter `cloud_proxy_id` when calling `update_cloud_proxy`")
