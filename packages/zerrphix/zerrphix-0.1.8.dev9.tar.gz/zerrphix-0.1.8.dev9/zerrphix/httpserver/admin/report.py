...
@report.route('/report/<regex("[0-9]+"):zp_db_log_id>')
@login_required
def db_log_entry(zp_db_log_id):
    db_log_dict = current_app.config["AdminHTTPReportFuncs"].get_db_log_entry(zp_db_log_id)
