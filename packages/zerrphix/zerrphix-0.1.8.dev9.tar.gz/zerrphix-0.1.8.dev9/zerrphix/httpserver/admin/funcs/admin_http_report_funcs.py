    ...
    def recent_fatal_exceptions(self, limit=5):
        ...
        if rslt_zp_fatal_exception_raised is not None:
            for zp_fatal_exception_raised in rslt_zp_fatal_exception_raised:
                return_list.append({'id': zp_fatal_exception_raised.ID,
