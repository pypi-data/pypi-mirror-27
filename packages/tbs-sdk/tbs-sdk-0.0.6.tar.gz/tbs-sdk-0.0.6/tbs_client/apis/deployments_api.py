...
class DeploymentsApi(object):
    ...
    def deployments_read(self, project, namespace, deployment, **kwargs):
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.deployments_read_read_with_http_info(project, namespace, deployment, **kwargs)
        else:
            (data) = self.deployments_read_read_with_http_info(project, namespace, deployment, **kwargs)
            return data

    def deployments_read_read_with_http_info(self, project, namespace, deployment, **kwargs):
        ...
        # verify the required parameter 'server' is set
        if ('deployment' not in params) or (params['deployment'] is None):
            raise ValueError("Missing the required parameter `deployment` when calling `projects_servers_read`")
    ...
    def deployments_delete_with_http_info(self, project, namespace, deployment, **kwargs):
        ...
        # verify the required parameter 'server' is set
        if ('deployment' not in params) or (params['deployment'] is None):
            raise ValueError("Missing the required parameter `deployment` when calling `projects_servers_delete`")
