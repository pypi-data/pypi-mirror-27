    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(blank=True, help_text='If template is selected, HTML message will not be used', null=True, on_delete=django.db.models.deletion.CASCADE, to='django_mail_admin.EmailTemplate', verbose_name='Template')),
            ],
            options={
