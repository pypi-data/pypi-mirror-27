...
class Douwa(object):
    ...
    def init_app(self, app):
        ...
        # REDIS连接
        redis.connect(r_host, r_port, r_db)
        ...
        if topic and self.conf["bootstrap.servers"] and self.conf["ssl.ca.location"] and self.conf['sasl.username'] and self.conf['sasl.password']:
