...
class Macaca(BaseWorker):
    ...
    def __ui_play(self):
        ...
        if self.platform == "iOS":
            appurl = server_api.get_latest_app('me.ele.ios.eleme', 'iOS', 'Release')
        else:
            appurl = server_api.get_latest_app('me.ele', 'Android', 'Release')
        test_run_data = {
        ...
        server_api.add_results_for_cases(test_run.get('id'), case_id, log, test_run_status, appurl)
