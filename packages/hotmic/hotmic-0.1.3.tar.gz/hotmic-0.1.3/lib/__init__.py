...
*iterable*. It expects the iterable object to implement __getitem__, __len__
and potentially length. If calling *len* on iterable raises an OverflowError, 
it will call iterable.length().'''

    try:
        iter_len = len(iterable)
    except OverflowError: # iterable too large for system ints, try a different method
