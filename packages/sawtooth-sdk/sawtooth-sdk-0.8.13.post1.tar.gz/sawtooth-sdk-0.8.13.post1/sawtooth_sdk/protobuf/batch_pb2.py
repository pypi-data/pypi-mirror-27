...
_BATCHHEADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='signer_pubkey', full_name='BatchHeader.signer_pubkey', index=0,
