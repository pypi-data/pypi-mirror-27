...
_BLOCKHEADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signer_pubkey', full_name='BlockHeader.signer_pubkey', index=2,
