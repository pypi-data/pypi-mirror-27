...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='',
  syntax='proto3',
  serialized_pb=_b('\n$sawtooth_sdk/protobuf/identity.proto\"\x8e\x01\n\x06Policy\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x1e\n\x07\x65ntries\x18\x02 \x03(\x0b\x32\r.Policy.Entry\x1a\x30\n\x05\x45ntry\x12\x1a\n\x04type\x18\x01 \x01(\x0e\x32\x0c.Policy.Type\x12\x0b\n\x03key\x18\x02 \x01(\t\"$\n\x04Type\x12\x0e\n\nPERMIT_KEY\x10\x00\x12\x0c\n\x08\x44\x45NY_KEY\x10\x01\"\'\n\nPolicyList\x12\x19\n\x08policies\x18\x01 \x03(\x0b\x32\x07.Policy\")\n\x04Role\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x13\n\x0bpolicy_name\x18\x02 \x01(\t\" \n\x08RoleList\x12\x14\n\x05roles\x18\x01 \x03(\x0b\x32\x05.RoleB\x1e\n\x1asawtooth.identity.protobufP\x01\x62\x06proto3')
)
...
_POLICY_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='Policy.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='PERMIT_KEY', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DENY_KEY', index=1, number=1,
      options=None,
      type=None),
  ],
