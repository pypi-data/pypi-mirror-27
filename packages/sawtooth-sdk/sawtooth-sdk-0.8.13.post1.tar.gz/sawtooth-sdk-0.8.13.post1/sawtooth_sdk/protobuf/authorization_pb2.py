...
_AUTHORIZATIONCHALLENGESUBMIT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='payload', full_name='AuthorizationChallengeSubmit.payload', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='AuthorizationChallengeSubmit.signature', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='roles', full_name='AuthorizationChallengeSubmit.roles', index=3,
