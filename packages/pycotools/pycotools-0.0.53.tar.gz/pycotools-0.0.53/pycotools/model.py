...
class Model(_base._Base):
    ...
    def convert_particles_to_molar(particles, mol_unit, compartment_volume):
        ...
        LOG.debug('particles --> {}'.format(particles))
        LOG.debug('avagadro --> {}'.format(avagadro))
        LOG.debug('mol_unit_value --> {}'.format(mol_unit_value))
        LOG.debug('compartment_volume --> {}'.format(compartment_volume))
