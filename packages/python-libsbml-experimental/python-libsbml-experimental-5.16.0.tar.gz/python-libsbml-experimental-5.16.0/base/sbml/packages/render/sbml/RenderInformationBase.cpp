...
void RenderInformationBase::readAttributes (const XMLAttributes& attributes, const ExpectedAttributes& expectedAttributes)
{
  SBase::readAttributes(attributes, expectedAttributes);
    ...
    attributes.readInto("backgroundColor", mBackgroundColor, getErrorLog(), false, getLine(), getColumn());
}
/** @endcond */
...
bool RenderInformationBase::isSetReferenceRenderInformation() const
{
  return !mReferenceRenderInformation.empty();
}

int RenderInformationBase::unsetReferenceRenderInformation()
{
...
bool RenderInformationBase::isSetBackgroundColor() const
{
  return !mBackgroundColor.empty();
}
...
int RenderInformationBase::unsetBackgroundColor()
{
