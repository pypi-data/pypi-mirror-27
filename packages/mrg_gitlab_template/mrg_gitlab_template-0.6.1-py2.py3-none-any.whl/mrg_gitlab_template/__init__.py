...
def copy_template(base_dir, package_name):
    ...
    if path.exists(package_dir):
        logging.error('Package directory already exists: %s', package_dir)
        return
...
def main(cmdline=None):
    ...
    parser.add_argument('-g', '--group', required=True,
                        help='the gitlab account. Example: mrg-tools, sci-fv, your account name, etc')
    parser.add_argument('-p', '--pages-domain', default='gitlab.io',
                        help='the gitlab pages url domain. Example: gitlab.io, io.esa.int')
    parser.add_argument('-u', '--gitlab-url', default='gitlab.com',
                        help='the gitlab pages url domain. Example: gitlab.com, gitlab.esa.int')
    ...
    replace_in_dir(opts.directory, opts.package, opts.author, opts.email, opts.account, opts.year, opts.pages_domain, opts.gitlab_url)
