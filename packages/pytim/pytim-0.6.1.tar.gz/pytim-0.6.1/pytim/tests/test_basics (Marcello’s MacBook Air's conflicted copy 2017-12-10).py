...
class TestBasics():
    ...
    >>> line = filter(lambda l: 'ATOM     64 ' in l, PDB)[0]
    ...
    ...         ref = pytim.ITIM(u)
    ...         # mdtraj changes the atom names to types 
    ...         rdict = {'O':ref.radii_dict['OW'],'H':ref.radii_dict['HW']}
    ...         inter = pytim.ITIM(t, radii_dict=rdict)
    ...         ids_mda = []
    ...         ids_mdtraj = []
