...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'ardana-dv = ardana_configurationprocessor.cmd.ardana_dv:main',
            # ardana-dv.py for backwards compat - use ardana-dv
            'ardana-dv.py = ardana_configurationprocessor.cmd.ardana_dv:main',
            'ardana-pc = ardana_configurationprocessor.cmd.ardana_pc:main',
            # ardana-pc.py for backwards compat - use ardana-pc
            'ardana-pc.py = ardana_configurationprocessor.cmd.ardana_pc:main',
