...
class Operations(object):
    ...
    def list(
        ...
        Lists all the available ServiceFabric Resource Manager REST API
        operations.
        ...
        :rtype:
         ~azure.mgmt.seabreeze.models.OperationResultPaged[~azure.mgmt.seabreeze.models.OperationResult]
        :raises:
         :class:`ErrorModelException<azure.mgmt.seabreeze.models.ErrorModelException>`
        """
