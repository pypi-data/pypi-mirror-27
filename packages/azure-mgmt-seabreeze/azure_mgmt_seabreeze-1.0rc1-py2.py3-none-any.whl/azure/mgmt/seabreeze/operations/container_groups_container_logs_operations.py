...
class ContainerGroupsContainerLogsOperations(object):
    """ContainerGroupsContainerLogsOperations operations.
    ...
    def get(
            self, container_group_name, container_name, tail=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = '/subscriptions/{subscriptionId}/providers/Microsoft.ServiceFabric/containerGroups/{containerGroupName}/containers/{containerName}/logs'
