...
class ContainerInstanceView(Model):
    ...
    :type current_state: ~azure.mgmt.seabreeze.models.ContainerState
    :param previous_state: Previous container instance state..
    :type previous_state: ~azure.mgmt.seabreeze.models.ContainerState
    :param events: The events of this container instance.
    :type events: list[~azure.mgmt.seabreeze.models.ContainerEvent]
    """
