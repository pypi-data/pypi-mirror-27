...
class NewChatDialog(QtWidgets.QDialog):
    ...
    def chat_create(self):
        ...
        # print(contacts)
        self.chat_data = {
            "action": "new_chat", "chat_name": name, "contact_ids": users_data}
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def draw_msgslist(self):
        ...
        arr = [
            template.format(
                left="5px" if i["user_name"] == user_name else "25px",
                right="25px" if i["user_name"] == user_name else "5px",
                color="orange" if i["user_name"] == user_name else "blue",
                name=i["user_name"],
