...
def do_kanji(args, kanji):
    psm = init_pyjmdict(args.pyjmdict_uri_filename)
    osm = init_out(args.output_uri_filename)
    erc = init_erc(args.erc_uri_filename)
...
def main():
    ...
    parser.add_argument('-u', '--pyjmdict-uri-filename', required=True,
                        help='file from which to read pyjmdict database URI')
    parser.add_argument('-e', '--erc-uri-filename', required=True,
                        help='file from which to read explain-'
                        'reading cache database URI')
    parser.add_argument('-o', '--output-uri-filename', required=True,
