"""A setuptools based setup module for oxtie
...
setup(
    name='oxtie',
    version=version,
    description='Tools for saving NoSQL like data to various backends.',
    long_description=get_readme(),
    url='http://github.com/emin63/oxtie',
