...
class Post_22Endpoint:
    ...
    def create_2(self, obj, sourceResourceId, sourceResourceModified, isForward=None, returnFullResource=None, returnForwardedCopyPosts=None, impersonate_user_id=None, accept_type=None):
        """
        Copy existing post.
