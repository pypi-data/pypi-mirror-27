...
class MicrosoftExchangeSyncInfo_16Endpoint:
    ...
    def options(self, impersonate_user_id=None, accept_type=None):
        ...
        return fill(MicrosoftExchangeSyncInfo_16, response.json(), content_type=response.headers['Content-Type'], silence_exceptions=self.api_client.silence_fill_exceptions)
