...
setup(
    ...
    scripts=['imagerater'],                  # The name of your scipt, and also the command you'll be using for calling it
	...
	install_requires=['numpy', 'time', 'PIL','glob','matplotlib','sys','getopt'],
