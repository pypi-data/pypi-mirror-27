...
class AccountRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        return super(AccountRetrieveUpdateDestroy, self).update(request, *args, **kwargs)


class AccountUploadView(AccountRetrieveUpdateDestroy):
    ...
    def update(self, request, *args, **kwargs):
        instance = self.get_object()
        try:
            instance.account.__class__.objects.filter(id=instance.account.id).update(**request.data)
