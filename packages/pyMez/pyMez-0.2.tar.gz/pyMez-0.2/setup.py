...
if __name__ == '__main__':
    ...
    setup(
        name='pyMez',
		package_dir={'':'pyMez'} ,
        packages=find_packages('pyMez'),  # this must be the same as the name above
        version='0.2',
        ...
        classifiers=[],
		license="MIT",
		install_requires=['markdown','numpy','pandas','wx==3.0.2.0',"PIL<=4.0.0","pdfkit","pdoc","networkx","visa"],
    )
