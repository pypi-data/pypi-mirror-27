...
class ExampleUI(wx.Frame):
    def __init__(self, r, s, l):
        ...
        SubSizer.Add(SectionHead(self.Main, orientation=wx.HORIZONTAL, label=" RECTANGLE  ", shape="S"), SF_010A2)
        ...
        SubSizer.Add(SectionHead(self.Main, orientation=wx.HORIZONTAL, label=" RECTANGLE  ", shape="S", zOrder=1), SF_010A2)
...
class Dialog(BaseMain):
    def __init__(self, *args, **kwargs):
        ...
        self.AddButtonBundle(Sizer, label="ButtonBundle", tags=list("012345"), rows=2)
