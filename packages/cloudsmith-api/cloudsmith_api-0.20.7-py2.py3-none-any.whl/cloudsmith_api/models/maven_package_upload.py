...
class MavenPackageUpload(object):
    ...
    def __init__(self, status=None, package_type=None, stage_updated_at=None, is_sync_failed=None, sync_finished_at=None, checksum_sha256=None, repository_url=None, is_sync_in_progress=None, size=None, status_str=None, is_sync_awaiting=None, num_files=None, status_url=None, status_updated_at=None, namespace=None, distro_version=None, filename=None, sync_progress=None, epoch=None, version=None, is_sync_in_flight=None, namespace_url=None, slug_perm=None, uploader_url=None, checksum_sha1=None, distro=None, files=None, checksum_sha512=None, artifact_id=None, repository=None, format=None, is_sync_completed=None, downloads=None, version_orig=None, architectures=None, uploader=None, type_display=None, self_html_url=None, stage=None, self_url=None, packaging=None, slug=None, uploaded_at=None, name=None, license=None, stage_str=None, description=None, summary=None, subtype=None, checksum_md5=None, extension=None, release=None, group_id=None, format_url=None):
        """
