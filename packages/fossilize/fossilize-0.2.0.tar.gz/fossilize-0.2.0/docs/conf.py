# -*- coding: utf-8 -*-
#
# Fossilize documentation build configuration file, created by
...
version = fossilize.__version__
# The full version, including alpha/beta/rc tags.
release = fossilize.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'Fossilize Documentation',
     [u'Kale Kundert'], 1)
]
