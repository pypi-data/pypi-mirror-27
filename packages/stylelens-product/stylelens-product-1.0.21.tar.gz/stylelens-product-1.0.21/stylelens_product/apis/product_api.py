...
class ProductApi(object):
    ...
    def delete_products_by_hostcode_and_version_id(self, host_code, version_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_products_by_hostcode_and_version_id(host_code, version_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str host_code:  (required)
        :param str version_id:  (required)
        :param bool except_version: Delete all Products of versions except the VersionId
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_products_by_hostcode_and_version_id_with_http_info(host_code, version_id, **kwargs)
        else:
            (data) = self.delete_products_by_hostcode_and_version_id_with_http_info(host_code, version_id, **kwargs)
            return data

    def delete_products_by_hostcode_and_version_id_with_http_info(self, host_code, version_id, **kwargs):
        """
        Delete Products by Hostcode and VersionId
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_products_by_hostcode_and_version_id_with_http_info(host_code, version_id, callback=callback_function)
        ...
        all_params = ['host_code', 'version_id', 'except_version']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_products_by_hostcode_and_version_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'host_code' is set
        if ('host_code' not in params) or (params['host_code'] is None):
            raise ValueError("Missing the required parameter `host_code` when calling `delete_products_by_hostcode_and_version_id`")
        # verify the required parameter 'version_id' is set
        if ('version_id' not in params) or (params['version_id'] is None):
            raise ValueError("Missing the required parameter `version_id` when calling `delete_products_by_hostcode_and_version_id`")
        ...
        query_params = []
        if 'except_version' in params:
            query_params.append(('except_version', params['except_version']))
        ...
        return self.api_client.call_api('/products/hosts/{hostCode}/versions/{versionId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='DeleteProductsResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
