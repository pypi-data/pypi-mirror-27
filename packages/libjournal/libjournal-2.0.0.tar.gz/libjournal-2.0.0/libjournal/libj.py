...
class libJournal:
    ...
    @staticmethod
    def format_db (db_name: str):
        """
        Formats an existing SQL database
        :param db_name:
        :return:
        """
    ...
    def __set_latest_entry_number(self):
        ...
        self.entry_number = entry_number[-1]+1
    ...
    def most_recent_entry(self):
        """
        Will return & print data from the most recent entry.
        :return:
        """
        conn = sqlite3.connect(self.db_location)
        c = conn.cursor()
    ...
    def search_by_title(self, entry_title: str):
        """
        Searches for all entries with the name, and returns a list of entries & prints all the entries numbered
        :param entry_title:
        :return:
        """
        conn = sqlite3.connect(self.db_location)
    ...
    def search_by_date(self, entry_date: str):
        """
        Searches for all entries with the date, and returns a list of entries & prints all the entries numbered
        :param entry_date:
        :return:
        """
        conn = sqlite3.connect(self.db_location)
    ...
    def search_by_number(self, entry_number: int):
        """
        Searches for specific entry with entry_number, and returns & prints the entry
        :param entry_number:
        :return:
        """
        conn = sqlite3.connect(self.db_location)
