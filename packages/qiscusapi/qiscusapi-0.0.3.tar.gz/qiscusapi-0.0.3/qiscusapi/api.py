...
class Api(object):
    ...
    def system_event_message(self, room_id, subject_email, object_email=None,
                             updated_room_name=None):
        """
        ...
        :return: it will return object named room
        """
        comment = Comments.system_event_message(self, room_id, subject_email, object_email,
                                               updated_room_name)
        return comment
