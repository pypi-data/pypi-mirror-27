...
class UrlObject(object):
    ...
    def __init__(self, url):
        self.url = url
        self.obj = urllib.request.urlopen(url)

    def is_image(self):
        return self.obj.headers.get_content_maintype() == 'image'

    def get_maintype(self):
        return self.obj.headers.get_content_maintype()

    def get_subtype(self):
        return self.obj.headers.get_content_subtype()
