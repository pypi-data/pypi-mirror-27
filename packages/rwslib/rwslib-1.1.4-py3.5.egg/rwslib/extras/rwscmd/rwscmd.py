...
@click.group()
@click.option('--username', '-u', default=None, envvar='RWSCMD_USERNAME', help='Rave login')
@click.option('--password', '-p', default=None, hide_input=True, envvar='RWSCMD_PASSWORD', help='Rave password')
