...
class TVSeriesRenamerUnitTests(unittest.TestCase):
    ...
    def test_constructors(self):
        ...
        rec_root = TVSeriesRenamer(
            "temp_testing", PlexTvdbScheme, recursive=True
        )
    ...
    def test_renaming(self):
        ...
        game_of_thrones = TVSeriesRenamer(os.path.join(
            "temp_testing", "Game of Thrones"), PlexTvdbScheme)
        ...
        for result in expected_results:
            for episode in expected_results[result]:
                self.assertTrue(os.path.isfile(os.path.join(
                    "temp_testing", "Game of Thrones", result, episode
                ) + ".mkv"))
    ...
    def test_confirmationless_renaming(self):
        expected_results = {
            ...
            "Season 2": [
                "The Big Bang Theory - S02E05 - The Euclid Alternative",
                "The Big Bang Theory - S02E13 - The Friendship Algorithm"],
            "Season 3": [
                "The Big Bang Theory - S03E07 - The Guitarist Amplification",
                "The Big Bang Theory - S03E10 - The Gorilla Experiment"],
            "Season 4": [
                "The Big Bang Theory - S04E01 - The Robotic Manipulation",
                "The Big Bang Theory - S04E06 - The Irish Pub Formulation"],
            "Season 5": [
                "The Big Bang Theory - S05E08 - The Isolation Permutation",
        ...
        for result in expected_results:
            for episode in expected_results[result]:
                self.assertTrue(os.path.isfile(os.path.join(
                    "temp_testing", "The Big Bang Theory", result, episode
                ) + ".mkv"))

    def test_recursive_renamer_renaming(self):
        expected_game_of_thrones_results = {
            "Season 1": ["Game of Thrones - S01E01 - Winter Is Coming",
                         "Game of Thrones - S01E02 - The Kingsroad",
                         "Game of Thrones - S01E05 - The Wolf and the Lion",
                         "Game of Thrones - S01E10 - Fire and Blood",
                         "Game of Thrones - S01E11 - Episode 11"],
        ...
        recursive_root = \
            TVSeriesRenamer("temp_testing", PlexTvdbScheme, recursive=True)
    ...
    def test_unconfirmed_renaming(self):
        renamer = TVSeriesRenamer(
            os.path.join("temp_testing", "Game of Thrones"), PlexTvdbScheme
        )
        ...
        self.assertTrue(os.path.isfile(os.path.join(
            "temp_testing", "Game of Thrones", "Season 1", "Episode 01.mkv")))
