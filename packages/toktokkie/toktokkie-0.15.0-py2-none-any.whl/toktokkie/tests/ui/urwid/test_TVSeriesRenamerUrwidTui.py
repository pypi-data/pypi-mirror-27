...
class UnitTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        shutil.copytree(os.path.join(
            u"toktokkie", u"tests", u"resources", u"directories"), u"temp_testing")
    ...
    def test_parsing_non_media_directory_non_recursive(self):
        self.tui.dir_entry.set_edit_text(u"temp_testing")
    ...
    def test_removing_selection(self):
        ...
        self.tui.confirmation = [
            RenamerConfirmation(TVEpisode(
                u"test", 1, 1, u"Test", PlexTvdbScheme)),
            RenamerConfirmation(TVEpisode(
                u"test2", 2, 1, u"Test", PlexTvdbScheme)),
            RenamerConfirmation(TVEpisode(
                u"test", 3, 1, u"Test", PlexTvdbScheme))]
        self.tui.refresh()
