...
def build_proxy(mock_response=PactResponse()):
    class Proxy(SimpleHTTPServer.SimpleHTTPRequestHandler):
        ...
        def respond(self):
            ...
            self.end_headers()
            debug('=== === === === === === === === === === === === === === ===')
            debug(type(mock_response.body))
            debug(mock_response.body)
            debug(str(mock_response.body))
            debug(str(mock_response.body).encode())
            debug(str(mock_response.body).replace("'", '"').encode())
            debug('=== === === === === === === === === === === === === === ===')
