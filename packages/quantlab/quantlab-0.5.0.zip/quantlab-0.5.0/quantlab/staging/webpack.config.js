...
var Build = require('@quantlab/buildutils').Build;
...
var jlab = package_data.quantlab;
...
var data = {
  quantlab_extensions: extensions,
  quantlab_mime_extensions: mimeExtensions,
};
 ...
 */
function QuantLabPlugin(options) {
  _first = true;
}

QuantLabPlugin.prototype.apply = function(compiler) {
