...
def TaskReplyStart(builder): builder.StartObject(5)
...
def TaskReplyAddTaskSpec(builder, taskSpec): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(taskSpec), 0)
def TaskReplyAddUpdated(builder, updated): builder.PrependBoolSlot(4, updated, 0)
