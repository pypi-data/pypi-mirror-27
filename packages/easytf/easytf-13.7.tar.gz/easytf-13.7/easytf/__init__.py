...
#        self.conv_layer_out.append(self.batch_dropout(self.h_pool[layer_num]))  
     ...
     def fc_layer(self,layer_num):
        if layer_num ==0:
            ...
            self.fc_layer_out.append(tf.reshape(self.convout, [self.batch_size,self.convout.shape[1]*self.convout.shape[2]*self.convout.shape[3]]))
            self.w_fc.append(self.weight_init([self.convout.shape[1]*self.convout.shape[2]*self.convout.shape[3], self.n_hidden[layer_num]]))
        else:
