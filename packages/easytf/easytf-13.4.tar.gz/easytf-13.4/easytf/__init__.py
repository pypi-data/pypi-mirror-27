...
#        self.conv_layer_out.append(self.batch_dropout(self.h_pool[layer_num]))  
     ...
     def fc_layer(self,layer_num):
        if layer_num ==0:
            ...
            self.flat_shape=self.fc_layer_out[0].get_shape().as_list()
            print self.flat_shape
            print self.n_hidden[layer_num]
            self.w_fc.append(self.weight_init([self.flat_shape[1], self.n_hidden[layer_num]]))
        else:
