...
#              
       ...
       if  self.output_act=='softmax':   
           ...
           if self.cost_type=='CE':
               ...
               self.cost=CSFunctions.NewHybridCEMS(self.pred,self.y_ph,1/2.,self.seq_len-2)                
           elif self.cost_type=='HybridCEMS4':
               self.cost=CSFunctions.NewHybridCEMS(self.pred,self.y_ph,1/4.,self.seq_len-2)     
           elif self.cost_type=='HybridCE2-100':
               self.cost=CSFunctions.HybridCE(self.pred,self.y_ph,1/2.,self.seq_len-2,1)                
           elif self.cost_type=='HybridCE4-100':
               self.cost=CSFunctions.HybridCE(self.pred,self.y_ph,1/4.,self.seq_len-2,1) 
