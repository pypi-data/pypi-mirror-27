...
class audio_low_latency_record_init(item):
    ...
    def __init__(self, name, experiment, string=None):
        ...
        self.verbose = u'no'
        self.modules_enabled = [u'alsaaudio',u'pyaudio',u'ossaudiodev',u'sounddevice']
    ...
    def reset(self):
        ...
        self.oss4_module_name = u'OSS4 (Linux only)'
        self.pyaudio_module_name = u'PortAudio'
        self.sounddevice_module_name = u'SoundDevice'
