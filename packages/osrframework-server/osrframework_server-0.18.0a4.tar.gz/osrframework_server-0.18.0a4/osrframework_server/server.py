...
def getInfo():
    info = {
        ...
        "source_code": "https://github.com/i3visio/osrframework_server",
    }
...
def api_v1(command, query):
    ...
    This application can receive a random number set by the administrator
    ...
    -----
        ...
        query: The user name to be searched.

    Returns:
    --------
        A JSON with the answer recovered from the platform.
    """
    # Splitting the query
...
def not_found_error(error):
    ...
    Thee requested resource could not be found but may be available in the future. Subsequent requests by the client are permissible.
    """
    return render_template(
        'error.html',
        errorCode='404',
