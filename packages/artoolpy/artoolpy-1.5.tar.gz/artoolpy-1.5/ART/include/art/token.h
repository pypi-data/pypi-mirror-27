 ...
 */
#if defined(__GNUC__)
#define TOKEN __declspec(allocate(".token"))
#define INIT_FUNC(f) __declspec(allocate(".ctors"))
#if defined(__APPLE__) && defined(__MACH__)
  #define TOKEN __attribute__((section("__TOKEN, __token"))) const token
  #define INIT_FUNC(f) __attribute__((section("__CTORS,__ctors"))) void (*f##_ptr)(void) = &f;
#else
