...
APP = 'OHM2_BACKOFFICE_LIGHT_'

LOGIN_URL = getattr(settings, APP + 'LOGIN_URL', getattr(settings, "LOGIN_URL", "/login/"))
STAFF_PERMISSION_ENTER_VIEW = getattr(settings, APP + 'STAFF_PERMISSION_ENTER_VIEW', 
    ("enter_view", "User can enter the view"),
)
STAFF_PERMISSIONS = (
	STAFF_PERMISSION_ENTER_VIEW,
)