...
class ProjectAPI(object):
    ...
    def upload_anytype_file(self, stream, file_name, file_path, content_type_code,
        ...
        Example response:
        {
            ...
            "file_path": "usr/artifacts_stringExtractor/testing/test_files/"
            "columns":null,
        ...
        resp = self.do_post(upload_url, files={'file': (str(file_name)), stream, mimetype)},'file_path': (str(file_path)), data=values)
