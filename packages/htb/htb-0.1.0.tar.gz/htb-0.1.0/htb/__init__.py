...
class HTB:
    ...
    def _update_machines(self, url, attr):
    ...
    def update_active_machines(self):
        ...
        self._update_machines('https://www.hackthebox.eu/home/machines/list', self.active_machines)

    def update_retired_machines(self):
        '''Update retired_machines with a dict of currently retired machines'''
        self._update_machines('https://www.hackthebox.eu/home/machines/retired', self.retired_machines)
