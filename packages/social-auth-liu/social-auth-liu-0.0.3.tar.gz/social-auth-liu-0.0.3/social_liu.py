...
class ADFSOAuth2(BaseOAuth2):
    ...
    def authorization_url(self):
        return self.setting('AUTHORIZATION_URL', default='https://{0}/adfs/oauth2/authorize'.format(self.get_host()))

    def access_token_url(self):
        return self.setting('ACCESS_TOKEN_URL', default='https://{0}/adfs/oauth2/token'.format(self.get_host()))
