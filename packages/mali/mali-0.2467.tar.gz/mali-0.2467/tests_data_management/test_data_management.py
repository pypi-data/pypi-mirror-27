...
class TestDataManagement(BaseTest):
    ...
    def testClonedFilesWithNewMetadata(self):
        ...
        self.assertEqual(first_staging_query_result[0]['first'], '1')
        self.assertEqual(first_staging_query_result[1]['first'], '1')
        ...
        self.assertEqual(second_staging_query_result[0]['first'], None)
        self.assertEqual(second_staging_query_result[1]['first'], None)
        self.assertEqual(second_staging_query_result[0]['second'], '2')
        self.assertEqual(second_staging_query_result[1]['second'], '2')
