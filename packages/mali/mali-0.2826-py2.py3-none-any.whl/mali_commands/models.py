...
from missinglink import KerasCallback, TensorFlowProject, PyCaffeCallback, PyTorchCallback
...
def get_weights_hash(ctx, framework, model, weights):
    ...
    For example, if the model is saved as `checkpoint.pt`, to calculate te hash:

    \b
        mali model getWeightsHash --framework torch --model checkpoint.pt
