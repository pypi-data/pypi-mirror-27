...
class ExceptionHandlerControllerWrapper(ControllerWrapper):
    ...
    def _execute_wrapped_function(
        ...
        try:
            ...
            # raw_resposne = self.context.build_default_error(exc)
...
#     [...]
#
#     def build_default_error(self, exc):
#         return self._error_builder.build_from_exception(exc)
