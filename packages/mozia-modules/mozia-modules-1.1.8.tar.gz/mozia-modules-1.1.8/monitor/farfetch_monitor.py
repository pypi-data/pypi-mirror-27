...
def compare_platform_product(monitor_task, source_sizes):
...
def crawl_product_for_monitor(monitor_task):
    ...
    if sizes_string:
        ...
        if not sizes:
            ...
            # TODO: 这里需要处理尺码已下架的情况
            if compare_platform_product(monitor_task, source_sizes=sizes):
