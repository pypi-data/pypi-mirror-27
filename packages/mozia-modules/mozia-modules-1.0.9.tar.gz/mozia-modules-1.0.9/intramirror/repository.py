...
def create_connection():
    return pymysql.connect(host="databasehost", port=3066, user='dba', passwd='123456', db='intramirror',
                           charset='utf8mb4', cursorclass=pymysql.cursors.DictCursor)


class MonitorRepository(Repository):
    def __init__(self):
        Repository.__init__(self, db="fashion_product", port=3066, host="databasehost")
