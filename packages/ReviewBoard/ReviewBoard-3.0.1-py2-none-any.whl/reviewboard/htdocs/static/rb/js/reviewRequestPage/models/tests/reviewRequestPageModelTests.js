    ...
    describe('Dynamic updating', function () {
        ...
        describe('Response parsing', function () {
            ...
            it('Updates to outdated entries', function () {
                ...
                page._processUpdates(['177\n', '{"type": "entry", "entryType": "my-entry", ', '"entryID": "1", "addedTimestamp": "2017-07-01T00:00:00", ', '"updatedTimestamp": "2017-09-04T14:30:20", ', '"modelData": {"myAttr": "value1"}}', '15\n', '<p>My HTML!</p>', '177\n', '{"type": "entry", "entryType": "my-entry", ', '"entryID": "2", "addedTimestamp": "2017-07-01T00:00:00", ', '"updatedTimestamp": "2017-09-03T14:30:20", ', '"modelData": {"myAttr": "value2"}}', '13\n', '<p>Oh hi!</p>'].join(''));
            ...
            it('Updates to up-to-date entries', function () {
                ...
                page._processUpdates(['177\n', '{"type": "entry", "entryType": "my-entry", ', '"entryID": "1", "addedTimestamp": "2016-09-04T14:30:20", ', '"updatedTimestamp": "2016-12-10T12:24:14", ', '"modelData": {"myAttr": "value1"}}', '15\n', '<p>My HTML!</p>'].join(''));
            ...
            it('Updates to non-entries', function () {
                page._processUpdates(['35\n{"type": "something", "foo": "bar"}', '20\n<div>Something</div>'].join(''));
