...
RB.NotificationManager = Backbone.View.extend({
    ...
    setup: function setup() {
        this._canNotify = this.NotificationType !== undefined && RB.UserSession.instance.get('enableDesktopNotifications');
    ...
    notify: function notify(options) {
        ...
        this._notification = new RB.NotificationManager.Notification(options.title, {
            text: options.body,
        ...
        _.delay(notification.close.bind(notification), this.NOTIFICATION_LIFETIME_MSECS);
    }
}, {
    instance: null,
