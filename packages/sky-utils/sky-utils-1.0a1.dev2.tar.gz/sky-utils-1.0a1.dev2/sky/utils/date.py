...
class TzAwareDateService():
    ...
    def current_tr_time():
        """
        :return: python datetime object for current time in turkey timezone, this method adds tzinfo standart dt.dt.now()

        Args:
            tz (object): 
        """
        return datetime.datetime.now(tz=TzAwareDateService.tz_tr())
