...
class PSICROMETRICO():
    ...
    def marca_estado(self, estado, colorplot='red', colortext='red', printtag=True,
        ...
        plt.plot([estado.tseca[0]],[estado.W[0]],self.colormap[colorplot]+'o', markersize=pointsize)
        if printtag:
            self.escount += 1
