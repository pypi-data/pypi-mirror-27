...
setup(
    name=PACKAGE,
    version=VERSION,
    url='https://www.lacoretechnologies.com/payment-services/',
    license='MIT License',
    author='Lacore Technologies',
    author_email='support@lacoretechnologies.com',
    description='Lacore API Python client',
