...
def get_version_from_init():
    path = join(abspath(module_name), '__init__.py')
    try:
...
try:
    ...
    if __version__ is None:
        __version__ = __import__(module_name).__version__
    else:
...
setup(use_scm_version={'root': directory},
      ...
      author='jtara1',
      author_email='',
      url='https://github.com/jtara1/temp_test2',
      download_url='{github_url}/archive/{version}.tar.gz' \
      .format(github_url='https://github.com/jtara1/temp_test2',
              version=version),
