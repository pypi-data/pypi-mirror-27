...
"""
pre_style_body = """</style> <meta charset="UTF-8"> </head> <body> <div class="navbar navbar-default navbar-static-top" role="navigation"> <div class="container"> <div class="navbar-header"> <a class="navbar-brand">Report</a> <div class="project-name visible-md visible-lg">"""
passed_end = """</div> </div> </div> </div> </div> </div> </div> </div> </div> </div>"""
...
class BuildTestData(object):
    ...
    def add_pass_status_on_label(self):
        pre_style_passed = """<div class="all-features"> <div style="display: none;">No features</div> <div class="panel panel-default"> <div class="panel-heading" id="directory"> <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseSuitehappy"> <i class="glyphicon glyphicon-chevron-right"></i> <i class="glyphicon glyphicon-chevron-down"></i> <b>PASSED</b> <span class="label-container"> <span class="label label-success" title="3 Features Passed">%s</span> </span> </a> </h4> </div> <div id="collapseSuitehappy" class="panel-collapse collapse"> <div class="panel-body"> <div class="row"> <div class="col-lg-6 col-md-6"> <div class="panel panel-default"> <div class="panel-heading"> <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseFeaturehappy0"> <i class="glyphicon glyphicon-chevron-right"></i> <i class="glyphicon glyphicon-chevron-down"></i> <b>Passed Scenarios :</b>Click here <span class="label-container"> <span class="label label-success" title="4 Scenarios Passed"></span> </span> </a> </h4> </div> <div id="collapseFeaturehappy0" class="panel-collapse collapse"> <div class="panel-body">"""%(self.total_passed)
        return pre_style_passed

    def add_failed_status_on_lable(self):
        pre_style_failed = """<div class="panel panel-default"> <div class="panel-heading" id="directory"> <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseSuiteunhappy"> <i  class="glyphicon glyphicon-chevron-right"></i> <i class="glyphicon glyphicon-chevron-down"></i> <b>FAILED</b> <span   class="label-container"> <span  style="background-color:red" class="label label-success" title="1 Features Passed">%s</span> </span> </a> </h4> </div> <div id="collapseSuiteunhappy" class="panel-collapse collapse"> <div class="panel-body"> <div class="row"> <div class="col-lg-6 col-md-6"> <div class="panel panel-default"> <div class="panel-heading"> <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseFeatureunhappy0"> <i class="glyphicon glyphicon-chevron-right"></i> <i class="glyphicon glyphicon-chevron-down"></i> <b>Failed Scenarios :</b>Click Here <span class="label-container"> </span> </a> </h4> </div> <div id="collapseFeatureunhappy0" class="panel-collapse collapse"> <div class="panel-body">"""%(self.total_failed)
    ...
    def generate_final_report(self):
        ...
        data = pre_html_body+pre_style_body+self.env_setup+pre_style_passed+"<div class='panel panel-default'>"+passed_body+passed_end+pre_style_failed+"<div class='panel panel-default'>"+failed_body+failed_end+post_html_style_1+pie_chart_result+post_html_style_2+post_html_body
        file_name = os.path.abspath(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))+"/report.html")
        try:
