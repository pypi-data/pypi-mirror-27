...
class TestCommandLine(BaseTestCloud):
    ...
    def test_create_recipe(self):
        ...
        DKFileUtils.write_file(file_path, contents.replace('[YOUR EMAIL HERE]', 'unittests@datakitchen.io'))
        contents = DKFileUtils.read_file(file_path)
        self.assertTrue('unittests@datakitchen.io' in contents)
        ...
        self.assertTrue(0 == result.exit_code)
        self.assertTrue('succeeded' in result.output)
        self.assertTrue('unittests@datakitchen.io' in result.output)
        ...
        contents = DKFileUtils.read_file(file_path)
        DKFileUtils.write_file(file_path, contents.replace('unittests@datakitchen.io', 'blah+dk@datakitchen.io'))
        contents = DKFileUtils.read_file(file_path)
        self.assertTrue('blah+dk@datakitchen.io' in contents)
        self.assertTrue('[YOUR EMAIL HERE]' not in contents)
        self.assertTrue('unittests@datakitchen.io' not in contents)
