...
class Cell(object):
    ...
    """
    Used to indicate if cell is dirty, which means re-evaluation is required
    """
    @property
    def dirty(self):
        return self.__dirty
    ...
    def make_cells(excel: object, rng: object, sheet=None) -> object:
        ...
        def convert_range(rng, sheet=None):
            ...
            try:
                ...
                # Removed: below doesn't work in case that vs has less columns such that cells are ignored
                # Example: in case the last column contains only formulas.
