...
export default class SelectForMlanguageControl extends React.PureComponent {
  constructor(props) {
    super(props);
...
SelectForMlanguageControl.propTypes = propTypes;
SelectForMlanguageControl.defaultProps = defaultProps;
