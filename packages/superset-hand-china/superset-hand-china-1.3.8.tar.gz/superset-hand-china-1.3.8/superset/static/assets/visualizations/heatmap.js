...
function heatmapVis(slice, payload) {
  ...
  if (fd.show_legend) {
    ...
    .call(colorLegend);
    svg.selectAll('.legendCells')[0][0].firstChild.getElementsByClassName('label')[0].style.cssText +='opacity:1';
    svg.selectAll('.legendCells')[0][0].lastChild.getElementsByClassName('label')[0].style.cssText +='opacity:1';
  }
