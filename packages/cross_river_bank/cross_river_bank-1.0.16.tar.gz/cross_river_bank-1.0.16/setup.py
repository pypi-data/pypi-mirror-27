"""
Cross River Bank Python client library.
...
setup(
    name=PACKAGE,
    version=VERSION,
    url='https://www.crossriverbank.com/',
    license='MIT License',
    author='Cross River Bank',
    author_email='support@crossriverbank.com',
    description='Cross River Bank API Python client',
