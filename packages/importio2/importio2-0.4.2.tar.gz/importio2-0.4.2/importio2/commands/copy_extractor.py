...
source_api_key = 'f59043c4763b40678d65bd216da373777aa8ce61fda03406d06f829122f719ef6697c804c82742374000699b716b66c6501e1bb1a235968c3639c0a25ca2ab125537e28c32084ffccd6601d4d5bd5173'
...
def copy(object_name, guid):
    ...
    print 'copy', 'https://%s/store/%s/%s' % (source, object_name, guid)
    ...
    for attachment in attachments:
        print 'copy attachment', 'https://%s/store/%s/%s/_attachment/%s/%s' % (source, object_name, guid, attachment['key'], attachment['guid'])
    ...
    for sub_object in sub_objects:
        print 'copy sub_object', sub_object['key']
