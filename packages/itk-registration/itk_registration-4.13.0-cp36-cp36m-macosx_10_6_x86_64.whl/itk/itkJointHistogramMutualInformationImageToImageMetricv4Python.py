...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_itkJointHistogramMutualInformationImageToImageMetricv4Python')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_itkJointHistogramMutualInformationImageToImageMetricv4Python')
