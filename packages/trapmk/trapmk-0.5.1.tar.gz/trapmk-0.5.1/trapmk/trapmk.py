...
<!-- FILE GENERATED BY TRAPMK AT {epoch} -->
"""
...
def make_category_index(category_buffer: list, category_name: str,
    ...
    template_variables = {
        'posts': category_buffer,
        'title': 'Posts in %s Category' % category_name,
    }
    category_index_file_path = os.path.join(buffer_category_path, 'index.html')
    make_page(
...
def make_page(source_file_path: str, destination: str = None,
    ...
    output = GENERATED_FILE_HEADER.format(epoch=time.time()) + output
