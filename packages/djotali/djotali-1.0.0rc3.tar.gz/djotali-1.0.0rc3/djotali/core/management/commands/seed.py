    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            try:
                ...
                Product.objects.create(name='Pack économique',
                                       description='Lorem ipsum dolor sit amet, consectetuer adipiscing elit.\nAenean commodo ligula eget dolor. Aenean massa.',
                                       price=Price(5000, currency='XOF'))
                Product.objects.create(name='Pack premium',
                                       description='Lorem ipsum dolor sit amet, consectetuer adipiscing elit.\nAenean commodo ligula eget dolor. Aenean massa.',
                                       price=Price(10000, currency='XOF'))
                Product.objects.create(name='Pack business',
                                       description='Lorem ipsum dolor sit amet, consectetuer adipiscing elit.\nAenean commodo ligula eget dolor. Aenean massa.',
                                       price=Price(20000, currency='XOF'))
                Product.objects.create(name='Pack not published',
                                       description='Lorem ipsum dolor sit amet, consectetuer adipiscing elit.\nAenean commodo ligula eget dolor. Aenean massa.',
                                       price=Price(50000, currency='XOF'), is_published=False)
