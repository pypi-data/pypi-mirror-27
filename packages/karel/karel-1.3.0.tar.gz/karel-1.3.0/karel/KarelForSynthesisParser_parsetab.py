...
# KarelForSynthesisParser_parsetab.py
...
_lr_productions = [
  ...
  ('prog -> DEF RUN M_LBRACE stmt M_RBRACE','prog',5,'p_prog','parser_for_synthesis.py',103),
  ('stmt -> while','stmt',1,'p_stmt','parser_for_synthesis.py',112),
  ('stmt -> repeat','stmt',1,'p_stmt','parser_for_synthesis.py',113),
  ('stmt -> stmt_stmt','stmt',1,'p_stmt','parser_for_synthesis.py',114),
  ('stmt -> action','stmt',1,'p_stmt','parser_for_synthesis.py',115),
  ('stmt -> if','stmt',1,'p_stmt','parser_for_synthesis.py',116),
  ('stmt -> ifelse','stmt',1,'p_stmt','parser_for_synthesis.py',117),
  ('stmt_stmt -> stmt stmt','stmt_stmt',2,'p_stmt_stmt','parser_for_synthesis.py',127),
  ('if -> IF C_LBRACE cond C_RBRACE I_LBRACE stmt I_RBRACE','if',7,'p_if','parser_for_synthesis.py',137),
  ('ifelse -> IFELSE C_LBRACE cond C_RBRACE I_LBRACE stmt I_RBRACE ELSE E_LBRACE stmt E_RBRACE','ifelse',11,'p_ifelse','parser_for_synthesis.py',166),
  ('while -> WHILE C_LBRACE cond C_RBRACE W_LBRACE stmt W_RBRACE','while',7,'p_while','parser_for_synthesis.py',197),
  ('repeat -> REPEAT cste R_LBRACE stmt R_RBRACE','repeat',5,'p_repeat','parser_for_synthesis.py',219),
  ('cond -> cond_without_not','cond',1,'p_cond','parser_for_synthesis.py',241),
  ('cond -> NOT C_LBRACE cond_without_not C_RBRACE','cond',4,'p_cond','parser_for_synthesis.py',242),
  ('cond_without_not -> FRONT_IS_CLEAR','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',254),
  ('cond_without_not -> LEFT_IS_CLEAR','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',255),
  ('cond_without_not -> RIGHT_IS_CLEAR','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',256),
  ('cond_without_not -> MARKERS_PRESENT','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',257),
  ('cond_without_not -> NO_MARKERS_PRESENT','cond_without_not',1,'p_cond_without_not','parser_for_synthesis.py',258),
  ('action -> MOVE','action',1,'p_action','parser_for_synthesis.py',264),
  ('action -> TURN_RIGHT','action',1,'p_action','parser_for_synthesis.py',265),
  ('action -> TURN_LEFT','action',1,'p_action','parser_for_synthesis.py',266),
  ('action -> PICK_MARKER','action',1,'p_action','parser_for_synthesis.py',267),
  ('action -> PUT_MARKER','action',1,'p_action','parser_for_synthesis.py',268),
  ('cste -> INT','cste',1,'p_cste','parser_for_synthesis.py',276),
]
