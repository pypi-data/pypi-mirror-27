...
class InterfaceValue(utils.ReprObject):
    ...
    def __copy__(self):
        ...
        """
        kwargs = {v:copy.copy(getattr(self,v)) for v in [n for n in \
            inspect.getfullargspec(self.__init__).args if not n == "self"]}
    ...
    def __deepcopy__(self, memo = None):
        ...
        """
        kwargs = {v:copy.deepcopy(getattr(self,v)) for v in [n for n in \
            inspect.getfullargspec(self.__init__).args if not n == "self"]}
        return self.__class__(**kwargs)
