...
class NumericalModelGui(object):
    ...
    def adjustment_from_iv(self, iv, nsteps=1000):
        ...
        lower, upper = self.lim_from_iv(iv)
                ...
                if len(ivlist) == 1:
                    ...
                    for iv in ivlist:
                        ...
                        try:
                            ...
                            plot_kwargs.update({"label": "{} ({}) {} {} ({})" .format(
                                iv.name, iv.id, _("vs."), main_iv.name, main_iv.id)})
                            ax.scatter(
