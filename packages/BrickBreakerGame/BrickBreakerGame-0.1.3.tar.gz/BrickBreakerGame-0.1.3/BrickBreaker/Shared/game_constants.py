...
class GameConstants:
    ...
    standard_brick_image_url = "https://i.imgur.com/PMIv8sa.png"
    standard_brick_image_str = urlopen(standard_brick_image_url).read()
    ...
    STANDARD_BRICK_IMAGE = io.BytesIO(standard_brick_image_str)
