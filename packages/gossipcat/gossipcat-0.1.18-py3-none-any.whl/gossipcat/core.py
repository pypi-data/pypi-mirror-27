...
def simAnneal(train, target, predictors, cate_features, params=param_1, results=True, seed=320):
    ...
    gbm = LGBMClassifier(
        ...
        categorical_feature=cate_features, save_binary=True, is_unbalance=True, random_state=seed
    )
