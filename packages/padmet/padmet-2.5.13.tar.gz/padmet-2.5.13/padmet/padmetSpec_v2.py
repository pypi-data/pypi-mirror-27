...
#==============================================================================
    ...
    def updateFromSbml(self, sbml_file, padmetRef = None, mapping_dict = None, verbose = False, force = False, source_tool = None, source_category = None):
        """
        ...
        if mapping_dict is not None:
            if verbose: print("Parsing %s" %mapping_dict)
            with open(mapping_dict,'r') as f: #open the file               
