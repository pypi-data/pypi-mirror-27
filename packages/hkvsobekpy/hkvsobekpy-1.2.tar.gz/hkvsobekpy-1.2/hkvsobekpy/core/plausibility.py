...
class __plausibility_class(object):
    ...
    def read_his_series(self, his_file, location, parameter, his_folder, 
        ...
        hisfile = his_reader.LeesMetadata(os.path.join(his_folder, '{0}.his'.format(his_file).upper()))
    ...
    def plot_bui_his(self, df_his, df_bui_sel, start_his, end_his, df_bui_std, df_his_std, his_file, parameter, location, out_folder, savefigure, threshold_bar=4, barwidth = 0.02, baroffset=0.01):
        if threshold_bar > 3:
            threshold_bar = 3
        ...
        if len(df_bui_sel.columns) > threshold_bar:
    ...
    def EnsembleRunner(self, shp_file, bui_file, his_folder, out_folder, 
        ...
        for idx in progress_bar:        
            ...
            df_his = self.read_his_series(his_file, location, parameter, his_folder,
                            normalize_by_unicode, include_simularity, sequence_simularity)
